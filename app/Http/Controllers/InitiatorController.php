...
class InitiatorController extends Controller
{
    ...
    public function applications(Request $request) {
    	...
    	return view('user.pension-section.initiator.application-list', compact('applications', 'request'));
    }
    	...
    	try {
            ...
            if(!empty($application_form)) {
                ...
                if($request->application_status == 1) {
                    ...
                    $message = 'Initiator has been approved the application no - ' . $application_form->application_no . '. Please check the application details.';
                    ...
                    $message = 'Initiator has been returned the application no - ' . $application_form->application_no . '. Please check the application details.';
                ...
                return redirect()->route('initiator_applications');
            } else {
                DB::commit();
