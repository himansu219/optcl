                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item "><a href="{{route('bank_branch_details')}}">Bank Branch Master</a></li>
                         <li class="breadcrumb-item active" aria-current="page">Add Bank Branch</li>
                      </ol>
                    </nav>
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="bank_branch_form" method="post" action="{{URL('bank-branch-submit')}}">
                      @csrf
                      <div class="row">
                          <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail3">IFSC Code</label> <span class="span-red">*</span>
                                  <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder="Enter ifsc code" autocomplete="off">
                      ...
                      <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                  <label for="exampleInputEmail3">MICR Code</label>
                                    <input type="text" class="form-control" id="micr_code" name="micr_code" placeholder="Enter micr code" autocomplete="off">
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" id="address" name="address" placeholder="Enter address" autocomplete="off"></textarea>
