                  ...
                  @endif
                    <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Bank Names Master</li>
                      </ol>
                    </nav>
             <div class="card">
                <div class="card-body">
                     <h4 class="card-title">Manage Bank Names</h4>
                     <a class="btn btn-success btn-sm addClassbtn" href="{{route('bank_name_add')}}"><i class="icon-plus">ADD</i></a>
                     <div class="row">
                           ...
                           <table id="sortable-table-1" class="table table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <!-- <th class="sortStyle">Bank Code</th>  -->
                                    <th class="sortStyle">Bank Type</th>
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>{{$list->bank_type->bank_type}}</td>
                                    <td>
                                      <label class="switch">
                                    ...
                                    <td>
                                    <a class="" href="{{URL('bank-name/edit/'.$list->id)}}" title="edit"><i class="fa fa-edit"></i></a>
 ...
 @endsection
  ...
  <script type="text/javascript">
    $(document).ready(function(){
     ...
     $.ajax({
         type: "POST",
         url: '{{route("check_status_bank_name")}}',
  ...
  $(".deleteUser").on("click",function () {
   ...
   swal( {
      ...
      closeOnCancel: true,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/bank-name-delete/"+userID;
