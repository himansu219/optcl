...
<div class="content-wrapper">
         ...
         <div class="col-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('country_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                      ...
                      <table id="sortable-table-1" class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th class="sortStyle">Country Code</th> 
                        ...
                        @foreach($result as $key => $list)
                          <tr>
                            ...
                            <a class="" href="{{URL('country/edit/'.$list->id)}}" title="edit"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
       ...
       $.ajax({
           type: "POST",
           url: '{{route("check_status_country")}}',
   ...
   swal( {
      ...
      closeOnCancel: true,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/country-delete/"+userID;
