                ...
                @endif
                    <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">DA Rate</li>
                      </ol>
                    </nav>
             <div class="card">
               <div class="card-body">
                  <h4 class="card-title">Filter</h4>
                  <form class="forms-sample" id="filter_da_form" method="post" action="{{ route('da_details') }}">
                      @csrf
                      <div class="row">
                       <div class="col-md-4">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Dearness Allowance</h4>
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('da_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                        ...
                        <table id="sortable-table-1" class="table table-striped">
                          <thead>
                            <tr>
                              ...
                              <th class="sortStyle">% Of Basic Pay </th>
                          ...
                          @foreach($result as $key => $list)
                            <tr>
                              ...
                              <td>{{ $list->percentage_of_basic_pay }}</td>
                              <td>
                                <label class="switch">
                              ...
                              <td>
                              <a class="" href="{{URL('da/edit/'.$list->id)}}" title="edit"><i class="fa fa-edit"></i></a>
  ...
  $(document).ready(function(){
    ...
    swal( {
      ...
      closeOnCancel: true,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/da_delete/"+userID;
