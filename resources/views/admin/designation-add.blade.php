         ...
         <div class="content-wrapper">
              ...
              <div class="card">
                <div class="card-body">
                 ...
                 <form class="forms-sample" id="designation_form" method="post" action="{{URL('designation_submit')}}">
                      @csrf
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputName1">Designation Name</label> <span class="span-red">*</span>
                            <input type="text" class="form-control" id="designation_name" name="designation_name" placeholder="Enter designation name" autocomplete="off">
                        </div>
                      </div>
                      <!-- <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputEmail3">Designation Code</label> <span class="span-red">*</span>
                            <input type="text" class="form-control" id="designation_code" name="designation_code" placeholder="Enter designation code" autocomplete="off">
                        </div>
                      </div> -->
                    </div>
