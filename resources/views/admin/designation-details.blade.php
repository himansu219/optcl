...
<div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Designations Master</li>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('designation_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                      ...
                      <table id="sortable-table-1" class="table table-striped">
                          ...
                          <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                <a class="" href="{{URL('designation/edit/'.$list->id)}}"title="edit"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
      ...
      $.ajax({
          type: "POST",
          url: '{{route("check_status_designation")}}',
    ...
    //alert(userID);
     swal( {
      ...
      //closeOnConfirm: false, closeOnCancel: false,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/designation_delete/"+userID;
