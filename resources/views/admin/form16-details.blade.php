...
<div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Form 16</h4>
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('form16_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                        ...
                        <tbody>
                            ...
                            @foreach($result as $key => $list)
                              <tr>
                                ...
                                <td> <a href="{{ asset('public/' . $list->form_16_file_path) }}" target="_blank"><i class="fa fa-file-pdf-o"></i></a> </td>
                                ...
                                <td>
                                <a class="" href="{{URL('form16/edit/'.$list->id)}}"title="edit"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
   ...
   swal( {
      ...
      //closeOnConfirm: false, closeOnCancel: false,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/form16_delete/"+userID;
