            ...
            <div class="col-12 grid-margin">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="{{route('form16_add')}}">Add Form 16</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Edit Form 16</li> 
                    </ol>
              </nav>
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Edit Form 16</h4>
                  
                  <form class="forms-sample" id="form16_form" method="post" action="{{URL('form16_update/'.$result['0']->id)}}" enctype="multipart/form-data">
                      @csrf
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                          <label>Edit Form 16 file  <span class="span-red">*</span></label>
                        ...
                        <div class="form-group">
                          <label>Upload Date <span class="span-red">*</span></label>
                            <div id="datepicker-joining" class="input-group date datepicker ">
                              <input type="text" class="form-control" autocomplete="off" id="upload_date" name="upload_date" value="{{ \Carbon\Carbon::parse($result['0']->upload_date)->format('d-m-Y') }}">
