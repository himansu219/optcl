                  ...
                  @endif
                    <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nominee Preference</li>
                      </ol>
                    </nav>
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Nominee Preference</h4>
                  <div class="row">
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                      <table id="sortable-table-1" class="table table-striped">
                        <thead>
                          <tr>
                            <th>Sl No.</th>
                            <th class="sortStyle">Nominee Preference</th>
...
<script type="text/javascript">
    $(document).ready(function(){
     ...
     $.ajax({
         type: "POST",
         url: '{{route("check_status_nominee")}}',
