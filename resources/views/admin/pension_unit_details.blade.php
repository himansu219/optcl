...
<div class="content-wrapper">
                ...
                @endif
                        <nav aria-label="breadcrumb" role="navigation">
                          <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Pension Units Master</li>
                            
                          </ol>
                        </nav>
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Pension Units</h4>
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('pension_unit')}}"><i class="icon-plus">ADD</i></a>
                   <div class="row">
                      ...
                      <table id="sortable-table-1" class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th class="sortStyle">Unit Code</th>
                        ...
                        <tbody>
                          ...
                          @foreach($result as $key => $list)
                            <tr>
                              ...
                              <td>
                              <a class="" href="{{URL('pension-unit/edit/'.$list->id)}}" title="edit"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
    ...
    $('.status_check').change(function() {
      ...
      $.ajax({
          type: "POST",
          url: '{{route("check_status_pension_unit")}}',
...
$(".deleteUser").on("click",function () {
   ...
   swal( {
      ...
      closeOnCancel: true,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/pension_unit_delete/"+userID;
