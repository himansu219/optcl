...
<div class="content-wrapper">
            ...
            <div class="col-12 grid-margin">
                  ...
                  <nav aria-label="breadcrumb" role="navigation">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Relation Master</li>
                         
                      </ol>
                    </nav>
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage Relations</h4>
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('relation_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                      ...
                      <table id="sortable-table-1" class="table table-striped">
                        <thead>
                          <tr>
                            ...
                            <th class="sortStyle">Relation Name</th>
                        ...
                        @foreach($result as $key => $list)
                          <tr>
                            ...
                            <td>
                              <a class="" href="{{URL('relation/edit/'.$list->id)}}"title="edit"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
       ...
       $.ajax({
           type: "POST",
           url: '{{route("check_status_relation")}}',
   ...
   swal( {
      ...
      //closeOnConfirm: false, closeOnCancel: false,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/relation_delete/"+userID;
