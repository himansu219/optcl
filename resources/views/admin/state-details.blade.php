        ...
        <div class="col-12 grid-margin">
              ...
              <div class="card">
               <div class="card-body">
                  ...
                  <form class="forms-sample" id="filter_state" method="post" action="{{ route('state_details') }}">
                      @csrf
                      <div class="row">
                        <div class="col-md-4">
            ...
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Manage States </h4>
                <a class="btn btn-success btn-sm addClassbtn" href="{{route('state_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                          ...
                          @foreach($result as $key => $list)
                            <tr>
                              ...
                              <td>
                                ...
                                <a class="" href="{{URL('state/edit/'.$list->id)}}" title="edit"><i class="fa fa-edit"></i></a>
  ...
  $(".deleteUser").on("click",function () {
   ...
   swal( {
      ...
      closeOnCancel: true,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/state-delete/"+userID;
