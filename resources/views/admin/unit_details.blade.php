...
<div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Manage OPTCL Units</h4>
                  <a class="btn btn-success btn-sm addClassbtn" href="{{route('unit_add')}}"><i class="icon-plus">ADD</i></a>
                  <div class="row">
                    ...
                    <table id="sortable-table-1" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @foreach($result as $key => $list)
                              <tr>
                                <td class="text-center">{{ $result->firstItem() + $key }}</td>
                                ...
                                <td>
                                  <a class="" href="{{URL('unit/edit/'.$list->id)}}"title="edit"><i class="fa fa-edit"></i></a>
  ...
  $(document).ready(function(){
    ...
    $('.status_check').change(function() {
      ...
      $.ajax({
          type: "POST",
          url: '{{route("check_status_optcl_unit")}}',
   ...
   swal( {
      ...
      //closeOnConfirm: false, closeOnCancel: false,
        ...
        .then((value) => { 
          if(value){ 
              location.href=base_url+"/unit_delete/"+userID;
