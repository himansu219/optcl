         ...
         <nav aria-label="breadcrumb" role="navigation">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="user_form" method="post" action="{{URL('user-submit')}}">
                      @csrf
                    <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail3">User Name  <span class="span-red">*</span></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email_id" name="email_id" placeholder="Enter email Id" minlength="5" autocomplete="off">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                                <label for="exampleInputEmail3">Employee Code</label>
                                <input type="text" class="form-control" id="employee_id" name="employee_id" placeholder="Enter employee Id" maxlength="5" autocomplete="off">
                            </div>
                          </div>
                   ...
                   <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aadhaar_no" name="aadhaar_no" placeholder="Enter aadhaar no" maxlength="12" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="exampleInputName1">Mobile No  <span class="span-red">*</span></label>
                            <input type="text" class="form-control" id="user_mobile_no" name="user_mobile_no" placeholder="Enter user mobile no" maxlength="10" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4" id="userDesg">
                        <div class="form-group"  >
                          <label>User Designation <span class="span-red">*</span></label>
                            <select class="js-example-basic-single" style="width:100%" id="designation" name="designation"  autocomplete="off">
                      ...
                      <div class="col-md-4 d-none" id="unitDivID" >
                        <div class="form-group">
                          <label>OPTCL Unit  <span class="span-red">*</span> </label>
                            <select class="js-example-basic-single" style="width:100%" id="unit_name" name="unit_name" autocomplete="off">
                              <option value="">Select OPTCL Unit</option>
                      ...
                      <div class="col-md-4 d-none" id="pensionunitDivID" >
                        <div class="form-group">
                          <label>Pension Unit  <span class="span-red">*</span> </label>
                            <select class="js-example-basic-single" style="width:100%" id="pension_unit_name" name="pension_unit_name" autocomplete="off">
                              <option value="">Select Pension Unit</option>
                                @foreach($pension_unit as $list)
                              <option value="{{$list->id}}">{{$list->pension_unit_name}}</option>
                                @endforeach
                            </select>
