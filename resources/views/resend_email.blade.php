<html>
 <body>
    ...
    <div style="background-color:#e8e8e8;margin:0;padding:0">
    ...
    <span><a href="#" style="color:#545d5e;text-decoration:none;outline:none" data-saferedirecturl="#">
        <img src="{{ $img_src }}" style="border:none;outline:none;width:250px;" class="CToWUd">
    </a><br></span></td>
    </tr>
    <tr>
    ...
    <p style="color: #000 !important">Hi {{ $name }},</p>
    <p style="color: #000 !important">
       <br/>
       
        User Id : {{ $mobile }}<br/>
        Please click on the link below to reset your password.<br/>
        Link : <a href = "{{ $verification_url }}">{{ $verification_url }}</a><br/>
    ...
    <p style="color: #000 !important; text-align:center;">OPTCL Pension Portal,Govt. of Odisha.</p>
