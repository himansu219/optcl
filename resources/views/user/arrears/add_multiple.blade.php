                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control datepicker-upto-current" id="arraer_from_date" name="arraer_from_date" readonly>
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control datepicker-upto-current" id="arrear_to_date" name="arrear_to_date" readonly>
                        ...
                        $('.page-loader').removeClass('d-flex');
                          if(response['error']){
                            ...
                            swal({
                              ...
                              .then((willDelete) => {
                              if(willDelete) {
                                let url = "{{route('billing_officer_arrears_multiple_arrear', ':queryId')}}";
                                url = url.replace(':queryId', application_id);
                                //var url_value = "{{route('billing_officer_arrears_multiple_arrear', ["application_id"])}}";
                                location.href = url;
                              }else{
