...
<div class="content-wrapper">
	<div class="row">
		<div class="col-12 grid-margin">
            ...
            @if(in_array($application->application_status_id, [1,15,16]))
            <form id="application-form" method="post" action="{{ route('applications_submission') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 2)
            <form id="application-recovery-form" method="post" action="{{ route('applications_store_recovery') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 12)
            <form id="application-form-2" method="post" autocomplete="off" action="{{ route('service_pension_form_submission') }}" enctype="multipart/form-data">
            @elseif($application->application_status_id == 15)
            <form id="form_resubmission" method="post" autocomplete="off" action="{{ route('service_pension_form_resubmission') }}">
            @else
            <form>
            @endif
                @csrf
    			...
    			<div class="card">
    				<div class="card-body">
    					<h4 class="card-title">Application Details
                            ...
                            @if(in_array($application->application_status_id, [1,16]))
                            ...
                            @endif
                            @if(in_array($application->application_status_id, [15]))
                                <button type="button" id="resubmission-btn" class="btn btn-danger float-right marg-left-col">Resubmit</button>
                            @endif
                        </h4>
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 3);
                                                        //dd($field_status);
                                                    @endphp

                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
                                                    ...
                                                    @else
                                                        <div class="preview">
                                                            <i class="fa fa-times" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" @if($field_status['remark_value'] != "") data-original-title="{{$field_status['remark_value']}}" @endif></i> 
                                                        </div>
                                                    @endif
    											</td>
    										</tr>
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 4);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 5);
                                                    @endphp
                                                    ...
                                                    @elseif($field_status['form_submit'] && $field_status['status_id'] == 'null')
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 6);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 7);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 8);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 9);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 79);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 10);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 11);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 12);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form1_id, 13);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 14);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 15);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 16);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 17);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="cName" value="2" data-fieldid="17" 
                                                                    @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 18);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 19);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 20);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 21);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 22);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 23);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 24);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="sName" value="2" data-fieldid="24" 
                                                                    @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 25);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="dName" value="2" data-fieldid="25" 
                                                                    @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 26);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 27);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 28);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 29);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 30);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 31);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 32);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 34);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 35);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 36);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 37);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 38);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 39);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 40);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 41);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 42);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 43);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form2_id, 44);
                                                    @endphp
                                                    @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="commutation_percentage" value="2" data-fieldid="44" 
                                                                    @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
    									...
    									<table class="table table-bordered">
    										@foreach($employee_nominees as $key=>$employee_nominee)
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											@if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                            @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                            @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										@if(!empty($employee_documents))
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusDA($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 0)
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                            ...
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    ...
                                                    <label for="staticEmail" class="col-form-label">Reason for non issue of No Demand Certificate</label>
                                                        <input type="text" name="form_reason_no_demand_certificate" class="form-control alpha_numeric">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row ml-2 mt-2">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input mt-2" name="form_provisional_pension" value="0">
                                                                        No
                                                                    </label>
                                                                </div>
                                                            </div>
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('applications_submission') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '.checkApprove', function() {
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("applications_approval") }}',
                    type:'post',
    ...
    $(document).ready(function() {
        ...
        $('#form_period_from_0').datepicker({
            ...
            $.ajax({
                ...
                data:'days='+from_days+'&start_date='+from_start_date+'&_token={{csrf_token()}}',
                async: false,
                success:function(result) {
            ...
            $.ajax({
                ...
                // data:'days='+total_cal_days+'&start_date='+from_start_date+'&_token={{csrf_token()}}',
                async: false,
                success:function(result) {
        ...
        $(document).on('click', '#add-service-rendered', function() {
            ...
            if($('#application-form-2').valid()) {
                ...
                let service_rendered_len_minus = service_rendered_len - 1;

                console.log(service_rendered_len_minus);
                ...
                $('#form_period_from_' + service_rendered_len).datepicker({
                    ...
                    todayHighlight: true,
                    format: 'dd/mm/yyyy',
                    startDate: $('#form_period_to_' + service_rendered_len_minus).val(),
                    endDate: $('#form_date_of_retirement').val()
                })
                /*.on('changeDate', function (selected) {
                    var minDate = new Date(selected.date.valueOf());
