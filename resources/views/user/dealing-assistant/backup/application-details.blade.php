    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 3);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 4);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 5);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 6);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 7);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 8);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 9);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 79);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 10);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 11);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 12);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form1_id, 13);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 14);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 15);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 16);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 17);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 18);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 19);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 20);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 21);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 22);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 23);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 24);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 25);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 26);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 27);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 28);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 29);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 30);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 31);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 32);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 34);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 35);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 36);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 37);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 38);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 39);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 40);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 41);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 42);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 43);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form2_id, 44);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										@foreach($employee_nominees as $key=>$employee_nominee)
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											@if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										@if(!empty($employee_documents))
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatus($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                ...
                                <div id="collapseSeven" class="collapse @if($application->application_status_id == 12) show @endif" role="tabpanel" aria-labelledby="headingSeven" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="form_last_basic_pay" id="form_last_basic_pay" class="form-control" value="{{ !empty($proposal->basic_pay_amount_at_retirement) ? number_format($proposal->basic_pay_amount_at_retirement, 2) : '' }}">
