...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-12 grid-margin">
            ...
            <form id="application-form" method="post" action="{{ route('nominee_dealing_assistant_submission') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 2)
            <form id="application-recovery-form" method="post" action="{{ route('nominee_dealing_assistant_recovery_submission') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 12)
            <form id="application-form-2" method="post" autocomplete="off" action="{{ route('nominee_dealing_assistant_form_ii') }}" enctype="multipart/form-data">
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 3);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 4);
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 5);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 6);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 7);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 8);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 9);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 79);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 10);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 11);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 12);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form1_id, 13);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 86);
                                                        //dd($field_status);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 87);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 88);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 89);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 90);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 91);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 92);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 93);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 14);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 15);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 94);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 16);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 17);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 18);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 30);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 31);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 32);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 35);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 39);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 40);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 41);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 42);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 36);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 37);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form2_id, 38);
                                                    @endphp
                                                    @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										@foreach($employee_nominees as $key=>$employee_nominee)
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											@if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										@if(!empty($employee_documents))
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatus($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] || ($field_status['form_submit'] && $field_status['is_latest'] == 0))
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control file-upload-info" disabled placeholder="Uplaod Last pay certificate">
                            ...
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse @if($application->application_status_id == 12) show @endif" role="tabpanel" aria-labelledby="headingSeven" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <button type="button" id="add-service-rendered" class="btn btn-success float-right">+ Add </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="form_last_basic_pay" class="form-control only_number" value="{{ !empty($proposal->basic_pay_amount_at_retirement) ? number_format($proposal->basic_pay_amount_at_retirement, 2) : '' }}" maxlength="9">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <label for="staticEmail" class="col-form-label">Reason for non issue of No Demand Certificate</label>
                                                        <input type="text" name="form_reason_no_demand_certificate" class="form-control alpha_numeric" value="">
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('nominee_dealing_assistant_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
                ...
                let html = "<div class='row recovery-len'>"+
                               ...
                               "<div class='col-md-4'>"+
                                    "<div class='form-group'>"+
                                        ...
                                        "<input type='text' class='form-control add_recovery_value only_number' name='add_recovery["+ recovery_len +"][value]' placeholder='Enter Recovery Value' required maxlength='7'>"+
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#non-qualifying-period-from').on('change', function(){
        ...
        $(document).on('change', '.form_period_to', function() {
            ...
            $('#form_period_from_' + key).valid();
            $('#form_period_to_' + key).valid();
