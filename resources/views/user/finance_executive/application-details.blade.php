...
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin">
            ...
            @if(in_array($application->application_status_id,[13, 17]))
            <form id="application-form" method="post" action="{{ route('ddo_applications_submission') }}">
            @elseif($application->application_status_id == 10)
            <form id="application-recovery-form" method="post" action="{{ route('fe_applications_store_recovery') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 18)
            <form id="application-form-2" method="post" autocomplete="off" action="{{ route('fe_service_pension_form_submission') }}">
            @else
            <form>
            @endif
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="accordion" id="accordion" role="tablist">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 3);
                                                        //var_dump($field_status);
                                                    @endphp
                                                    @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    ...
                                                    @elseif($field_status['status_id'] == 1)
                                                        <div class="preview"> 
                                                            <i class="fa fa-check"></i> 
                                                        </div>
                                                    @elseif($field_status['status_id'] == null)
                                                        
                                                    @else
                                                        <div class="preview"> 
                                                            <i class="fa fa-times" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" @if(isset($field_status['remark_value']) && $field_status['remark_value'] != "") data-original-title="{{$field_status['remark_value']}}" @endif></i> 
                                                        </div>
                                                    @endif
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 4);
                                                        //var_dump($field_status);
                                                    @endphp
                                                    @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 5);
                                                        //var_dump($field_status);
                                                    @endphp
                                                    @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="father_name" value="1" data-fieldid="5" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 6);
                                                    @endphp
                                                    ...
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="gender_name" value="1" data-fieldid="6" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 7);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 8);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 9);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 79);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="pf_account_no" value="2" data-fieldid="79" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 10);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 11);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="date_of_birth" value="2" data-fieldid="11" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 12);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form1_id, 13);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 14);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="permanent_addr_at" value="2" data-fieldid="14" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 15);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="permanent_addr_post" value="2" data-fieldid="15" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 16);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 17);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 18);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="state_name" value="1" data-fieldid="18" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 19);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 20);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 21);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="present_addr_post" value="2" data-fieldid="21" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 22);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 23);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 24);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 25);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 26);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 27);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="mobile_no" value="2" data-fieldid="27" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 28);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 29);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 30);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 31);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="bankName" value="1" data-fieldid="31" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 32);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="branchName" value="1" data-fieldid="32" @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 34);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 35);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="pension_unit_id" value="1" data-fieldid="35" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="pension_unit_id" value="2" data-fieldid="35" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 36);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 37);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ number_format(($proposal->civil_service_received_amount ? $proposal->civil_service_received_amount : 'NA'),2)  }}</td>
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 38);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 39);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 40);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 41);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 42);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 43);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form2_id, 44);
                                                    @endphp
                                                     @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                        ...
                                        <table class="table table-bordered">
                                            @foreach($employee_nominees as $key=>$employee_nominee)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input checkApproveNominee checkApprove" name="nominee_name_{{$employee_nominee->id}}" value="1" data-fieldid="46" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_mobile_no_{{$employee_nominee->id}}" value="1" data-fieldid="47" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input checkApproveNominee checkApproveNominee checkApprove" name="nominee_date_of_birth_{{$employee_nominee->id}}" value="1" data-fieldid="48" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="dob_attachment_path_{{$employee_nominee->id}}" value="1" data-fieldid="49" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_gender_name_{{$employee_nominee->id}}" value="1" data-fieldid="50" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_relation_name_{{$employee_nominee->id}}" value="1" data-fieldid="51" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                @if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                             @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                            <div class="row marg-left">
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="spouse_death_date_{{$employee_nominee->id}}" value="1" data-fieldid="53" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                            Approve
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            @elseif($application->application_status_id != 1 && $field_status['form_submit'] && $field_status['status_id'] == 1)
                                                                <div class="preview"> 
                                                                    <i class="fa fa-check"></i> 
                                                                </div>
                                                            @else
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                             @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                            <div class="row marg-left">
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="spouse_death_certificate_path_{{$employee_nominee->id}}" value="1" data-fieldid="54" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                            Approve
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_prefrence_{{$employee_nominee->id}}" value="1" data-fieldid="55" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_bank_name_{{$employee_nominee->id}}" value="1" data-fieldid="56" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_branch_name_{{$employee_nominee->id}}" value="1" data-fieldid="57" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_savings_bank_account_no_{{$employee_nominee->id}}" value="1" data-fieldid="58" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_marital_status_name_{{$employee_nominee->id}}" value="1" data-fieldid="59" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_aadhaar_no_{{$employee_nominee->id}}" value="1" data-fieldid="60" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="employement_status_{{$employee_nominee->id}}" value="1" data-fieldid="61" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $employee_nominee->total_income_per_annum ? number_format($employee_nominee->total_income_per_annum,2) : 'NA'  }}</td>
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="total_income_per_annum_{{$employee_nominee->id}}" value="1" data-fieldid="62" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="is_physically_handicapped_{{$employee_nominee->id}}" value="1" data-fieldid="63" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="disability_certificate_path_{{$employee_nominee->id}}" value="1" data-fieldid="64" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="disability_percentage_{{$employee_nominee->id}}" value="1" data-fieldid="65" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="pension_amount_share_percentage_{{$employee_nominee->id}}" value="1" data-fieldid="66" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="is_minor_{{$employee_nominee->id}}" value="1" data-fieldid="67" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="legal_guardian_name_{{$employee_nominee->id}}" value="1" data-fieldid="68" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="legal_guardian_age_{{$employee_nominee->id}}" value="1" data-fieldid="69" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="legal_guardian_addr_{{$employee_nominee->id}}" value="1" data-fieldid="70" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                         @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="legal_guardian_attachment_path_{{$employee_nominee->id}}" value="1" data-fieldid="71" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                        ...
                                        <table class="table table-bordered">
                                            @if(!empty($employee_documents))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusFE($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if(($field_status['form_submit'] == 'true' && $field_status['is_latest'] == null && $application->application_status_id == 17) || ($field_status['form_submit'] == 'true' && $field_status['is_latest'] == 1 && $application->application_status_id == 13))
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input checkApprove" name="field_action_{{ $employee_document->field_id }}" value="1" data-fieldid="{{ $employee_document->field_id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4 marg-left-col">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input checkfield" name="field_action_{{ $employee_document->field_id }}" value="2" data-fieldid="{{ $employee_document->field_id }}" @if($field_status['status_id'] == 2) checked @endif>
                                                                        Reject
                                                                    </label>
                                                                </div>
                                                            </div>
                            ...
                            @if($application->application_status_id == 10)
                            <div class="card">
                                ...
                                <div id="collapseSix" class="collapse @if($application->application_status_id == 2) show @endif" role="tabpanel" aria-labelledby="headingSix" data-parent="#accordion">
                                    <div class="card-body">
                                            ...
                                            <div class="row recovery-len">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control add_recovery_value only_number" name="add_recovery[{{$key}}][value]" value="{{$recoveryDetails->recovery_value}}" placeholder="Enter Recovery Value" required maxlength="7">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Last Pay Certificate</label>
                                            ...
                                            <div class="col-md-4 last-pay-cer">
                                                <div class="form-group">
                            ...
                            @endif
                            @if($add_recovery->count() > 0 && $application->application_status_id != 10)
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingSix">
                                        <h6 class="mb-0">
                            ...
                            @if($application->application_status_id == 18)
                            <div class="card">
                                ...
                                <div id="collapseSeven" class="collapse @if($application->application_status_id == 12) show @endif" role="tabpanel" aria-labelledby="headingSeven" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="form_last_basic_pay" class="form-control form_last_basic_pay" value="{{ !empty($service_form->last_basic_pay) ? number_format($service_form->last_basic_pay) : '' }}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row ml-2 mt-2">
                                                            <div class="col-md-2">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="form_provisional_pension" value="1" @if($service_form->is_no_demand_certificate == 0 && $service_form->is_recommended_provisional_pension == 1) checked @endif>
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                            ...
                            @endif
                            @if(!empty($service_form) && $application->application_status_id != 18)
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingSeven">
                                        <h6 class="mb-0">
                                        <a class="collapsed" data-toggle="collapse" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">Part - II</a>
                                                ...
                                                <div class="col-md-12">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tfoot>
                                                            ...
                                                            @if($service_form->non_qualifying_period_from != NULL && $service_form->non_qualifying_period_to != NULL)
                                                            <tr>
                                                                <th colspan="1">Non-Qualifying Period</th>
                                                                <td colspan="2">
...
<div class="modal fade" id="main_application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="" method="post" id="return_remark_form" accept-charset="utf-8">
        @csrf
        <input type="hidden" name="reject_application_id" id="reject_application_id" value="{{ $application->id }}">
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('ddo_applications_submission') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.checkApprove').on('change', function() {
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("ddo_applications_approval") }}',
                    type:'post',
                    data:'field_id='+field_id+'&_token={{csrf_token()}}&application_id='+application_id+'&status_id='+1,
        ...
        $(document).on('click', '.checkfield', function() {
            var field_id = $(this).data('fieldid');
            var status_id = this.value;
            var application_id = $('#application_id').val();
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("get_rejection_remark") }}',
                    type:'post',
        ...
        $("#return_remark_form").validate({
            ...
            submitHandler: function(form, event) { 
                    ...
                    $.ajax({
                        type:'POST',
                        url:'{{ route("ddo_applications_rejection") }}',
                        data: formData,
                        dataType: 'JSON',
                        processData: false,
                        contentType: false,
                ...
                let html = "<div class='row recovery-len'>"+
                                "<div class='col-md-4'>"+
                                    "<div class='form-group'>"+
                                        ...
                                        "<input type='text' class='form-control add_recovery_label' name='add_recovery["+ recovery_len +"][label]'  placeholder='Enter Recovery Label' required>"+
                               ...
                               "<div class='col-md-4'>"+
                                    "<div class='form-group'>"+
                                        ...
                                        "<input type='text' class='form-control add_recovery_value' name='add_recovery["+ recovery_len +"][value]'  placeholder='Enter Recovery Value' required>"+
                                ...
                                "<div class='col-md-4'>"+
                                    "<div class='form-group'>"+
                                        "<label>&nbsp;&nbsp;</label>"+
                                        "<button id='del-recovery' class='btn btn-danger del-recovery-btn'><i class='fa fa-trash-o'></i></button>"+
                                    "</div>"+
                                "</div>"+
                            "</div>";
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form_date_of_joining').datepicker({
            ...
            $('#form_date_of_retirement').datepicker('setStartDate', minDate);
        });
        ...
        $('#form_period_from_0').datepicker({
            ...
            // calculate orgnisation from and to dates
            var total_from_days = 0;
            var total_length = $('.form_period_from').length;
            var form_count = 0;

            for(i=0;i<total_length;i++){
                var from_date = formatDate($('#form_period_from_'+i).datepicker('getDate'));
                var from_to = formatDate($('#form_period_to_'+i).datepicker('getDate'));

                var from_days = (new Date(from_to) - new Date(from_date)) / (1000 * 60 * 60 * 24);

                total_from_days = total_from_days + from_days;

                // calculate from and to period year months and days                
                $.ajax({
                    url:'{{ route("convert_days_to_year_month_days") }}',
                    type:'post',
                    data:'days='+from_days+'&start_date='+from_date+'&_token={{csrf_token()}}',
                    async: false,
                    success:function(result) {

                        $('.years_'+i).text(result.years);
                        $('.months_'+i).text(result.months);
                        $('.days_'+i).text(result.days);

                        $('#total_service_years_'+i).val(result.years);
                        $('#total_service_months_'+i).val(result.months);
                        $('#total_service_days_'+i).val(result.days);
                    }
                });
            }

            var from_start_date = formatDate($('#form_period_from_0').datepicker('getDate'));

            // calculate gross qualifying period year months and days
            $.ajax({
                url:'{{ route("convert_days_to_year_month_days") }}',
                type:'post',
                // data:'days='+total_from_days+'&_token={{csrf_token()}}',
                data:'days='+total_from_days+'&start_date='+from_start_date+'&_token={{csrf_token()}}',
                async: false,
                success:function(result) {

                    $('.gross_years').text(result.years);
                    $('.gross_months').text(result.months);
                    $('.gross_days').text(result.days);

                    $('#gross_years').val(result.years);
                    $('#gross_months').val(result.months);
                    $('#gross_days').val(result.days);
                }
            });

            // calculate non qualifying dates
            var period_to = $('#non-qualifying-period-to').datepicker('getDate');
            var period_from = $('#non-qualifying-period-from').datepicker('getDate');
            var non_qualifying_days = 0;

            if(period_from != null && period_to != null) {
                var non_to_date = formatDate(period_to);
                var non_from_date = formatDate(period_from);

                var non_qualifying_days = (new Date(non_to_date) - new Date(non_from_date)) / (1000 * 60 * 60 * 24);

                $.ajax({
                    url:'{{ route("convert_days_to_year_month_days") }}',
                    type:'post',
                    data:'days='+non_qualifying_days+'&start_date='+non_from_date+'&_token={{csrf_token()}}',
                    async: false,
                    success:function(result) {
            ...
            // calculate net qualifying period year months and days
            var total_cal_days = total_from_days - non_qualifying_days;

            $.ajax({
                url:'{{ route("convert_days_to_year_month_days") }}',
                type:'post',
                data:'days='+total_cal_days+'&_token={{csrf_token()}}',
                async: false,
                success:function(result) {

                    $('.net_years').text(result.years);
                    $('.net_months').text(result.months);
                    $('.net_days').text(result.days);

                    $('#net_qualifying_years').val(result.years);
                    $('#net_qualifying_months').val(result.months);
                    $('#net_qualifying_days').val(result.days);
                }
            });
        ...
        $('.form_last_basic_pay').keyup(function () { 
    ...
    $('.form_service_period_duly_from').on('change', function(){
        $(this).valid();
    });

    $('.form_service_period_duly_to').on('change', function(){
        $(this).valid();
    });

    $('.form_service_period_absence_from').on('change', function(){
        $(this).valid();
    });

    $('.form_service_period_absence_to').on('change', function(){
        $(this).valid();
    });
