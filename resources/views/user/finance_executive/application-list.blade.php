                      ...
                      @foreach($applications as $key => $application)
                        <tr>
                          ...
                          <td>
                            ...
                            <a  href="{{ route('ddo_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @else
                            <a  href="{{ route('family_pension_fe_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @endif
                          </td>
                        </tr>
                      @endforeach
