...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-12 grid-margin">
            ...
            @if(in_array($application->application_status_id, [13]))
            <form id="application-form" method="post" action="{{ route('nominee_finance_executive_submission') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 10)
            <form id="application-recovery-form" method="post" action="{{ route('nominee_finance_executive_recovery_submission') }}" autocomplete="off" enctype="multipart/form-data">
            @elseif($application->application_status_id == 18)
            <form id="application-form-2" method="post" autocomplete="off" action="{{ route('nominee_finance_executive_form_ii') }}" enctype="multipart/form-data">
    					...
    					<div class="accordion" id="accordion" role="tablist">
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 3);
                                                        //dd($field_status);
                                                    @endphp
                                                    ...
                                                    @elseif(!$field_status['form_submit'] && $field_status['status_id'] == 0)
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 4);
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 5);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 6);
                                                        //dd($field_status);
                                                    @endphp
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 7);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 8);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 9);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 79);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 10);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 11);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 12);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form1_id, 13);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    						...
    						<div class="card">
    							<div class="card-header" role="tab" id="headingTwo">
    								<h6 class="mb-0">
    									<a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Family Pensioner</a>
    								</h6>
    							</div>
    								...
    								<div class="card-body">
    									<table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 86);
                                                        //dd($field_status);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 87);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 88);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 89);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 90);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 91);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 92);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 93);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 14);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 15);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 94);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 16);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 17);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 18);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 30);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 31);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 32);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 35);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 39);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 40);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                <td>{{ !empty($proposal->relation_name) ? $proposal->relation_name : 'NA' }}</td>
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 41);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 42);
                                                    @endphp
                                                    @if($field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 36);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 37);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
    										...
    										<tr>
    											...
    											<td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form2_id, 38);
                                                    @endphp
                                                    @if($field_status['form_submit'])
    												<div class="row marg-left">
                                                        <div class="col-sm-4">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkApprove" name="commutation_percentage" value="1" data-fieldid="38" required @if($field_status['status_id'] == 1) checked @endif>
                                                                    Approve
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 marg-left-col">
                                                            <div class="form-radio">
                                                                <label class="form-check-label">
                                                                    <input type="radio" class="form-check-input checkfield" name="commutation_percentage" value="2" data-fieldid="38" @if($field_status['status_id'] == 2) checked @endif>
                                                                    Reject
                                                                </label>
                                                            </div>
                                                        </div>
    									...
    									<table class="table table-bordered">
    										@foreach($employee_nominees as $key=>$employee_nominee)
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_date_of_birth_{{$employee_nominee->id}}" value="1" data-fieldid="48" data-nomineeid="{{ $employee_nominee->id }}" required @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
                                                            </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											@if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                            @if($field_status['form_submit'])
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    												...
    												<tr>
    													...
    													<td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                            @if($field_status['form_submit'])
    														<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_savings_bank_account_no_{{$employee_nominee->id}}" value="1" data-fieldid="58" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="nominee_marital_status_name_{{$employee_nominee->id}}" value="1" data-fieldid="59" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="total_income_per_annum_{{$employee_nominee->id}}" value="1" data-fieldid="62" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="is_physically_handicapped_{{$employee_nominee->id}}" value="1" data-fieldid="63" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="disability_certificate_path_{{$employee_nominee->id}}" value="1" data-fieldid="64" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="pension_amount_share_percentage_{{$employee_nominee->id}}" value="1" data-fieldid="66" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input  checkApproveNominee checkApprove" name="legal_guardian_attachment_path_{{$employee_nominee->id}}" value="1" data-fieldid="71" data-nomineeid="{{ $employee_nominee->id }}" required 
                                                                        @if($field_status['status_id'] == 1) checked @endif>
                                                                        Approve
                                                                    </label>
                                                                </div>
    									...
    									<table class="table table-bordered">
    										@if(!empty($employee_documents))
    											...
    											<tr>
    												...
    												<td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusFE($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if($field_status['form_submit'])
    													<div class="row marg-left">
                                                            <div class="col-sm-4">
                                ...
                                <div id="collapseSeven" class="collapse @if($application->application_status_id == 12) show @endif" role="tabpanel" aria-labelledby="headingSeven" data-parent="#accordion">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="form_last_basic_pay" class="form-control only_number" value="{{ !empty($service_form->last_basic_pay) ? number_format($service_form->last_basic_pay, 2) : '' }}" maxlength="9">
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('nominee_finance_executive_submission') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<!-- Resubmission remark -->
<div class="modal fade" id="application_resubmission_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('dealing_assistant_applications_resubmission') }}" method="post" id="resubmission_remark_form" accept-charset="utf-8">
        @csrf
        <input type="hidden" name="application_id" value="{{ $application->id }}">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Resubmission</h5>
                    <button type="button" id="remove-modal" class="close modal-close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '.checkApprove', function() {
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("nominee_finance_executive_approval") }}',
                    type:'post',
        ...
        $("#return_remark_form").validate({
            ...
            submitHandler: function(form, event) { 
                    ...
                    $.ajax({
                        type:'POST',
                        url:'{{ route("nominee_finance_executive_submission") }}',
                        data: formData,
                        dataType: 'JSON',
                        processData: false,
                        contentType: false,
