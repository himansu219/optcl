        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <input type="hidden" class="form-control date_of_joining_value"  name="date_of_joining_value" id="date_of_joining_value" value="{{ (!empty($proposal->date_of_joining)) ? \Carbon\Carbon::parse($proposal->date_of_joining)->format('d/m/Y') : ''  }}">
                ...
                <tr>
                    ...
                    <input type="hidden" class="form-control date_of_retirement_value"  name="date_of_retirement_value" id="date_of_retirement_value" value="{{ (!empty($proposal->date_of_retirement)) ? \Carbon\Carbon::parse($proposal->date_of_retirement)->format('d/m/Y') : ''  }}">
                ...
                @php
                    $add_recovery = DB::table('optcl_employee_add_recovery')->where('status', 1)->where('deleted', 0)->where('application_id', $application->id)->get();
                @endphp
