                      ...
                      @foreach($applications as $key => $application)
                        <tr>
                          ...
                          <td>
                            ...
                            <a  href="{{ route('hr_executive_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @else
                            <a  href="{{ route('fp_hr_executive_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @endif                             
                          </td>
                        </tr>
                      @endforeach
