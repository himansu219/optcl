        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td colspan="3">{{ (!empty($proposal->dod)) ? \Carbon\Carbon::parse($proposal->dod)->format('d-m-Y') : 'NA'  }}</td>
                </tr>
                <tr>
                    <td rowspan="2">5</td>
                ...
                @php
                    //dd($proposal);
                    $last_basic_pay = DB::table('optcl_nominee_pension_service_form')->where('application_id', $application->id)->value('last_basic_pay');
                    //$last_basic_pay = $proposal->basic_pay_of_pensioner_time_of_retirement;
                ...
                <tr>
                    ...
                    <input type="hidden" name="da_percentage_value" id="da_percentage_value" value="{{ $get_da_percentage->percentage_of_basic_pay ?? '0' }}">
                ...
                @php
                    $add_recovery = DB::table('optcl_nominee_pension_service_form_three_recovery')->where('status', 1)->where('deleted', 0)->where('application_id', $service_form_three->application_id)->get();
                @endphp
        ...
        <div id="collapseEight" class="collapse" role="tabpanel" aria-labelledby="headingEight" data-parent="#accordion">
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    @php
                        $part_iii_data = DB::table('optcl_nominee_pension_service_form_three')->where('application_id', $application->id)->first();
                        $last_basic_pay = $part_iii_data->emolument_last_basic_pay;
