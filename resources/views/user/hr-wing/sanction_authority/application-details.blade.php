    			...
    			<div class="card">
    				<div class="card-body">
    					<h4 class="card-title">Application Details
                            ...
                            <a href="{{ route('sanction_order_generate', array($application->id)) }}" class="btn btn-success float-right" id="sanction-order-generate">Generate Sanction Order</a>
                            @endif

                            @if(in_array($application->application_status_id, [25]))
                            <a href="{{ route('gratuity_sanction_order_generate', array($application->id)) }}" class="btn btn-success float-right" id="sanction-order-generate">Generate Gratuity Sanction Order</a>
                            @endif
                            @if(in_array($application->application_status_id, [26]))
                            <a href="{{ route('application_forward_initiator', array($application->id)) }}" class="btn btn-success float-right" id="sanction-order-generate">Forward To Initiator</a>
                            @endif
    					...
    					<div class="accordion" id="accordion" role="tablist">
                            ...
                            @include('user.hr-wing.sanction_authority.form_part_3')

                            @include('user.hr-wing.sanction_authority.calculation_sheet')
...
<div class="modal fade" id="application_resubmit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('hr_sanction_authority_application_resubmission') }}" method="post" id="application_resubmit_remark" accept-charset="utf-8">
        @csrf
        <input type="hidden" name="application_id" id="return_application_id" value="{{ $application->id }}">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
