    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" id="filter_applications" method="post" action="{{ route('assignments') }}" autocomplete="off">
                @csrf
                <div class="row">
                  <div class="col-md-4">
      ...
      <div class="card">
        <div class="card-body">
            <h4 class="card-title">Assignment List
                ...
                <a href="{{ route('assignments_history') }}" class="btn btn-success float-right">Assignment History</a>   
                <a href="javascript:void(0)" class="btn btn-success float-right mr-2" id="assigned_to">Assign</a>                 
            </h4>
                  ...
                  <tbody>
                    @if($applications->count() > 0)
                      @foreach($applications as $key => $application)
                        <tr>
                          <td><input type="checkbox" name="" class="application_ids" value="{{ $application->id }}"></td>
                          ...
                          <td>
                            ...
                            <a  href="{{ route('application_approval', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @else
                            <a  href="{{ route('family_pension_hr_sanctioning_authority_assignment_app_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @endif
