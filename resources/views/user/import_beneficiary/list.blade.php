...
<div class="content-wrapper">
    <nav aria-label="breadcrumb" role="navigation" class="bg-white">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Life Certificate</li>
      </ol>
    </nav> 
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" style="left: -21px;">
                                            <a href="{{ route('pension_unit_life_certificate_view_page', [$application->id]) }}" class="dropdown-item delete_desig"><i class="fa fa-eye"></i>View Details</a>
                                        </div>
                                    </div>
                                </div>
                              </td>
