...
<div class="col-lg-6 d-flex align-items-center justify-content-center">
  <div class="auth-form-transparent text-left p-3">
    ...
    <h4 class="mb-0">Pension Portal!</h4>
    <h6 class="font-weight-light">Pensioner Login</h6>
    ...
    @endif
    <form class="pt-3" id="login_form" action="{{route('validate_user')}}" method="post">
      @csrf
      <div class="form-group">
        <label for="exampleInputEmail">Aadhaar No/Mobile No/Employee Code/PPO No.<span class="span-red">*</span></label>
        <div class="input-group">
          ...
          <input type="text" class="form-control form-control-lg border-left-0 anns" id="user_name" name="user_name" placeholder="Aadhaar/Mobile/Employee Code/PPO No" maxlength="12" minlength="5" autocomplete="off">
        </div>
      ...
      <div class="text-center">
        <a href="{{ route('forgot_service_pensioner_password') }}" class="auth-link text-black" >Forgot password?</a>
      </div>
      <div class="text-center mt-4 font-weight-light">
        Don't have an account? <a href="{{ route('nominee_registration') }}" class="text-primary">Create</a>
      </div>
       <div class="text-center mt-4 font-weight-light">
        Nominee login? <a href="{{ route('nominee_login') }}" class="text-primary">Click here</a>
      </div>
    </form>
...
<script type="text/javascript">
  $(document).ready(function(){
    $("#login_form").validate({
      ...
      messages: {
          user_name: {
          digits:'Aadhaar No/Mobile No/Employee Code/PPO No should be only digits.' ,
          required: 'Please enter aadhaar/mobile/employee code/ppo no',
