...
<div class="content-wrapper">
    <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><a href="{{route('monthly_changed_data_list')}}">Monthly Changed</a></li> 
          <li class="breadcrumb-item active" aria-current="page">Forward History</li> 
        </ol>
    </nav>
    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" id="filter_applications" method="post" action="{{ route('monthly_changed_data_history') }}" autocomplete="off">
                @csrf
                <div class="row">
                  <div class="col-md-3">
                ...
                <a href="{{ route('monthly_changed_data_history') }}" class="btn btn-warning">Reset</a>
            </form>
          </div>
      </div>
