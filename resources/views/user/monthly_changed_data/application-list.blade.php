...
<div class="content-wrapper">
    <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Monthly Changed</li> 
        </ol>
    </nav>
    ...
    <div class="col-12 grid-margin">
      <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" id="filter_applications" method="post" action="{{ route('monthly_changed_data_list') }}" autocomplete="off">
                @csrf
                <div class="row">
                  <div class="col-md-3">
                ...
                <a href="{{ route('monthly_changed_data_list') }}" class="btn btn-warning">Reset</a>
            </form>
          </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
            <h4 class="card-title">Application List                
                <a href="{{ route('monthly_changed_data_history') }}" class="btn btn-success float-right">Forward History</a>   
                <a href="javascript:void(0)" class="btn btn-success float-right mr-2" id="assigned_to">Forward To Billing Officer</a>                 
            </h4>
