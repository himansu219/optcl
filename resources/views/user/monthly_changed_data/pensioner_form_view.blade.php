                            ...
                            <div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h6 class="text-center-normal">PARTICULARS OF EX-EMPLOYEE</h6>
                                        <hr>
                                        <br />
                                        ...
                                        <form  class="forms-sample" autocomplete="off" id="pension_form" action="" method="post"    enctype="multipart/form-data">
                                           @csrf
                                              <div class="row form_1_">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="pesioner_type" name="pesioner_type">
                                                            ...
                                                            <option value="SP" @if($pensionerDetails->pensioner_type == 'SP') selected @endif>Service Pensioner</option>
                                                            <option value="FM" @if($pensionerDetails->pensioner_type == 'FM') selected @endif>Family Pensioner</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control anch" id="old_ppo_no" name="old_ppo_no"  placeholder="Enter PPO No" value="" maxlength="20">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword4">New PPO No<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control anch" id="old_ppo_no" name="old_ppo_no"  placeholder="Enter PPO No" value="" maxlength="20">
                                                        <label id="old_ppo_no-error" class="error text-danger" for="old_ppo_no"></label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control alpha" id="pensioner_name" name="pensioner_name" placeholder="Pensioner Name" >
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="mobile_number" name="mobile_number" placeholder="Mobile Number" maxlength="10">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="aadhaar_number" name="aadhaar_number" placeholder="Aadhaar No." maxlength="12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="employee_code" name="employee_code" placeholder="Employee Code" maxlength="5">
                                            ...
                                            <h6 class="text-center-normal mt-2" id="fam_title_h6">Family Pensioner Details</h6>
                                            <hr id="family_hr_line">
                                            <div class="row">
                                            ...
                                            <h6 class="text-center-normal mt-2">Gross Pension</h6>
                                                <hr>
                                            <div class="row">
                                            ...
                                            <h6 class="text-center-normal mt-2">Commutation</h6>
                                                <hr>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table class="table table-bordered" id="commutation_table_id">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-primary btn-next mr-2" id="commutation_add_button" >Add</button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
