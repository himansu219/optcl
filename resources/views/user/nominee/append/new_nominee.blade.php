<div class="row nominee_row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control mobile_no only_number" id="mobile_no_{{$key}}" placeholder="Enter Mobile no here." name="nominee[{{$key}}][mobile_no]" data-key="{{$key}}" minlength="10" maxlength="10" value="{{ !empty($nominee_details) ? $nominee_details->mobile_no : '' }}">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control savings_bank_account_no only_number" id="savings_bank_account_no_{{$key}}" placeholder=" Enter Saving Bank Account No" name="nominee[{{$key}}][savings_bank_account_no]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->savings_bank_account_no : '' }}" minlength="9" maxlength="18">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control aadhaar_no only_number" id="aadhaar_no_{{$key}}" placeholder="Enter Aadhaar no here." name="nominee[{{$key}}][aadhaar_no]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->nominee_aadhaar_no : '' }}" minlength="12" maxlength="12">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control total_income_per_annum only_number" id="total_income_per_annum_{{$key}}" placeholder="Enter Total Income per annum" name="nominee[{{$key}}][total_income_per_annum]"  data-key="{{$key}}"  value="{{ !empty($nominee_details) ? $nominee_details->total_income_per_annum : '' }}" maxlength="9">
    ...
    <div class="col-md-6 physically_handicapped" id="physically_handicapped_percentage_{{$key}}">
        <div class="form-group">
            ...
            <input type="text" class="form-control disability_percentage only_number" id="disability_percentage_{{$key}}" placeholder="Disability Percentage" name="nominee[{{$key}}][disability_percentage]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->disability_percentage : '' }}" maxlength="3">
    ...
    <div class="col-md-6 is_legal" id="is_legal_name_{{$key}}">
        <div class="form-group">
            ...
            <input type="text" class="form-control legal_guardian_name alpha" id="legal_guardian_name_{{$key}}" placeholder="Enter Legal Guardian Name" name="nominee[{{$key}}][legal_guardian_name]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->legal_guardian_name : '' }}" minlength="4" maxlength="50">
    ...
    <div class="col-md-6 is_legal" id="is_legal_age_{{$key}}">
        <div class="form-group">
            ...
            <input type="text" class="form-control legal_guardian_age only_number" id="legal_guardian_age_{{$key}}" placeholder="Enter Legal Guardian Age" name="nominee[{{$key}}][legal_guardian_age]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->legal_guardian_age : '' }}" maxlength="3">
