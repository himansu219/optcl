					...
					<div class="accordion" id="accordion" role="tablist">
						<div class="card">
							<div class="card-header" role="tab" id="headingOne">
								<h6 class="mb-0">
									<span class="text-primary">Family Pension Form</span>
									<a href="{{ route('edit_nominee_application_form') }}" class="fa fa-edit float-right"><i class="fa fa-pencil-square-o"></i></a>
								</h6>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingTwo">
								<h6 class="mb-0">
									<span class="text-primary">Family Pensioner</span>
									<a href="{{ route('edit_nominee_family_pensioner_form') }}" class="fa fa-edit float-right"><i class="fa fa-pencil-square-o"></i></a>
								</h6>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingThree">
								<h6 class="mb-0">
									<span class="text-primary">Nominees</span>
									<a href="{{ route('nominee_nominee_form') }}" class="fa fa-edit float-right"><i class="fa fa-pencil-square-o"></i></a>
								</h6>
							</div>
						...
						<div class="card">
							<div class="card-header" role="tab" id="headingFour">
								<h6 class="mb-0">
									...
									<a href="{{ route('nominee_pension_documents_page') }}" class="fa fa-edit float-right"><i class="fa fa-pencil-square-o"></i></a>
								</h6>															
