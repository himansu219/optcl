                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active-tab" id="home-tab" href="{{ route('edit_nominee_application_form') }}">1. FAMILY PENSION FORM</a>
                            </li>
                            <li class="nav-item">
                                           ...
                                           @csrf
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="datepicker-joining" class="input-group date">
                                                            <input type="text" class="form-control datepickerClass" readonly autocomplete="off" id="doj" name="doj" value="{{$pensionerDetails->date_of_joining ? date('d/m/Y',strtotime($pensionerDetails->date_of_joining)): '' }}">
                                                            <span class="input-group-addon input-group-append">
                                                                <span class="mdi mdi-calendar input-group-text"></span>
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="submit" name="" class="btn btn-primary btn-next mr-2" id="submit_form_1">NEXT</button>
                                                </div>                                                
                                            </div>
                  ...
                  success: function(response) {
                    $('.page-loader').removeClass('d-flex');
                      if(response['error']){
                        ...
                        location.href = "{{route('edit_nominee_application_form')}}";
                      }else{
                        // Success
                        //location.reload();
