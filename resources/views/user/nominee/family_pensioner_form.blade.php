                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab"  role="tab" aria-controls="home-1" aria-selected="false" href="{{ route('edit_nominee_application_form') }}">1. FAMILY PENSION FORM</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active-tab" id="profile-tab" data-toggle="tab" href="" role="tab" aria-controls="profile-1" aria-selected="true">2. FAMILY PENSIONER</a>
                            </li>
                            <li class="nav-item">
                                        ...
                                        <form  class="forms-sample" autocomplete="off" id="family_pensioner_form" action="" method="post" enctype="multipart/form-data">
                                           @csrf
                                            <div class="row form_1_">
                                                ...
                                                @php
                                                $ppo_no = DB::table('optcl_pension_application_form')
                                                            ->where('employee_code', Auth::user()->employee_code)
                                                            ->where('status',1)
                                                            ->where('deleted',0)
                                                            ->value('ppo_number');
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control only_number" id="ppo_no" name="ppo_no" value="{{ !empty($ppo_no) ? $ppo_no : 'NA' }}" placeholder="Enter PPO No" readonly>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="datepicker-popup" class="input-group date ">
                                                            <input type="text" class="form-control" readonly id="dod" name="dod"  value="">
                                                ...
                                                @php
                                                    if(!empty($nomineeFamilyPensioner->id)){
                                                 ...
                                                 <div class="col-md-6">
                                                    {{--<div class="form-group">
                                                      <label>Death Certificate<span class="span-red">*</span></label>
                                                        <input type="file" name="death_certificate" id="death_certificate" class="file-upload-default">
                                                    ...
                                                    <input type="hidden" name="death_certificate_path_hidden" id="death_certificate_path_hidden" class=" death_certificate_path_hidden">
                                        ...
                                        <div class="row form_1_">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="applicant_name" name="applicant_name" value="{{Auth::user()->first_name}}" placeholder="Applicant name" readonly>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="relationship" name="relationship">
                                                            ...
                                                            @foreach($relations as $relation)
                                                                 <option value="{{$relation->id}}" @if(isset($nominee_details->relationship_id) && $nominee_details->relationship_id == $relation->id ) selected @endif>{{$relation->relation_name}}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="row" style="margin-left: 0px;">
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input" name="employment_status" id="employment_status_yes" value="1">
                                                                            Yes
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input" name="employment_status" id="employment_status_no" value="0" checked="">
                                                                            No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <input type="text" class="form-control particular_of_employment alpha_numeric" name="particular_of_employment" id="particular_of_employment" placeholder="Enter particulars of employment">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="row" style="margin-left: 0px;">
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input" name="pension_status" id="pension_status_yes" value="1">
                                                                            Yes
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <div class="form-radio">
                                                                        <label class="form-check-label">
                                                                            <input type="radio" class="form-check-input" name="pension_status" id="pension_status_no" value="0" checked="">
                                                                            No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <input type="text" class="form-control particular_of_pension alpha_numeric" name="particular_of_pension" id="particular_of_pension" placeholder="Enter particulars of pension">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control alpha_numeric" maxlength="30" id="atpost" name="atpost" placeholder="Enter At here" value="{{ !empty($nomineeFamilyPensioner->postal_addr_at) ? $nomineeFamilyPensioner->postal_addr_at: ''}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputPassword4">Post<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control alpha_numeric" maxlength="30" id="postoffice" name="postoffice" id="postoffice" placeholder="Enter Post here" value="" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleInputName1">PIN Code<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control only_number" id="pincode" name="pincode" placeholder="Enter Pin no here" maxlength="6" value="" >
                                                    </div>
                                                    <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control only_number" id="saving_bank_ac_no" maxlength="18" name="saving_bank_ac_no" placeholder=" Saving Bank A/C No" value="{{ isset($nominee_details->savings_bank_account_no) ? $nominee_details->savings_bank_account_no: '' }}">
                                                    <label id="saving_bank_ac_no-error" class="error text-danger" for="saving_bank_ac_no"></label>
                                                </div>
                                             ...
                                             <div class="col-md-6">  
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control alpha civil_service" id="civil_service" name="civil_service" placeholder="Enter particulars of previous civil service name" >
                                                        <label id="civil_service-error" class="error mt-2 text-danger" for="civil_service"></label>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control gratuity_recieved only_number" id="gratuity_recieved" name="gratuity_recieved" placeholder="Enter amount and nature of any pension / gratuity received" maxlength="9">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="submit" name="submit" class="btn btn-primary btn-next mr-2" id="submit_form_2">NEXT</button>
                                                </div>                                                
                                            </div>
                                        </form>
                                    </div>
 ...
 @section('page-script')
  ...
  <script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#particular_of_employment').keyup(function () { 
            this.value = this.value.replace(/[^A-Za-z\ ]/g,'');
        });  

        $('#particular_of_pension').keyup(function () { 
            this.value = this.value.replace(/[^A-Za-z\ ]/g,'');
        });      
        ...
        $("#branch_name_address").on('change',function(){
            ...
            $.post("{{ route('nominee_get_branch_details') }}",{
              ...
              $('#branch_name_address-error').text('');
        ...
        $("#family_pensioner_form").validate({
            ...
            submitHandler: function(form, event) {
              ...
              $.ajax({
                  type:'POST',
                  url:'{{ route("save_nominee_family_pensioner_form") }}',
                  data: formData,
                  dataType: 'JSON',
                  processData: false,
                  contentType: false,
        ...
        $('#name_of_the_unit').change(function(){
            // $('.page-loader').addClass('d-flex');
            let sid=$(this).val();

            if(sid != '') {
              $('#name_of_the_unit-error').text('');
            }
        });
