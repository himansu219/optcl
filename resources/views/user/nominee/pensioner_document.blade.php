            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab" href="{{ route('nominee_nominee_form') }}">3. NOMINEES</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div>
                            ...
                            <form id="pension-documents" method="POST" class="forms-sample" enctype="multipart/form-data">
                                ...
                                @php
                                    $attach_one = App\Libraries\Util::get_nominee_document_details($id, 9);
                                @endphp
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of death certificate<span class="text-danger">*</span></label>
                                ...
                                @php
                                    $attach_four = App\Libraries\Util::get_nominee_document_details($id, 11);
                                @endphp
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Undertaking for recovery of excess payments, if any<span class="text-danger">*</span></label>
                                    <div class="col-sm-5 mrgtop">
                                ...
                                @php
                                    $attach_five = App\Libraries\Util::get_nominee_document_details($id, 12);
                                @endphp
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of the Pension Payment Order<span class="text-danger">*</span></label>
                                    <div class="col-sm-5 mrgtop">
                                ...
                                @php
                                    $attach_six = App\Libraries\Util::get_nominee_document_details($id, 13);
                                @endphp
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Power of Attorney (Authorisation to retrieve the dues of the deceased pensioner by the family members) if applicable<span class="text-danger">*</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <div class="col-sm-5 mrgtop">
                                ...
                                @php
                                    $attach_two = App\Libraries\Util::get_nominee_document_details($id, 14);
                                @endphp
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of legal heir certificate<span class="text-danger">*</span></label>
                                    <div class="col-sm-5 mrgtop">
                                ...
                                <a href="{{ route('nominee_nominee_form') }}" class="btn btn-default mr-2 btn-prev">PREVIOUS</a>
    ...
    $(document).ready(function() {
        $("#pension-documents").validate({
            ...
            submitHandler: function(form, event) {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("save_nominee_documents_details") }}',
                    data: formData,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        ...
                        if(response['error']) {
                            ...
                            location.href = "{{route('nominee_application_preview')}}";
                        }
                    }
                });
            },
