...
<div class="content-wrapper">
	<div class="row">
		<div class="col-12 grid-margin">
            ...
            <form id="application-form" method="post" autocomplete="off" action="">
                @csrf
    			<div class="card">
    				<div class="card-body">
    					<h4 class="card-title">Application Details
                            ...
                            @if(in_array($application->application_status_id, [46]))
                                <a href="{{ route('approver_ppo_order_generate', array($application->id)) }}" class="btn btn-success float-right" id="sanction-order-generate">Generate PPO</a>
                            @endif
                        </h4>
    					<div class="accordion" id="accordion" role="tablist">
                            ...
                            @include('user.pension-section.approver.form_part_3')
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('approver_applications_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<div class="modal fade" id="application_approved_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('approver_applications_approval') }}" method="post" id="application_approve_remark" accept-charset="utf-8">
        @csrf
