...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-12 grid-margin">
            ...
            <form id="application-form" method="post" autocomplete="off" action="{{ route('initiator_applications_approval') }}">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Application Details
                            @if(in_array($application->application_status_id, [42, 48]))
                            ...
                            @if(in_array($application->application_status_id, [46]))
                                <a href="{{ route('approver_family_pension_ppo_order_generate', array($application->id)) }}" class="btn btn-success float-right" id="sanction-order-generate">Generate PPO</a>
                            @endif
                        </h4>
                        <div class="accordion" id="accordion" role="tablist">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 3);
                                                        //dd($field_status);
                                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 4);
                                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 5);
                                                        //dd($field_status);
                                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 6);
                                                        //dd($field_status);
                                                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 7);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 8);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 9);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 79);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 10);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 11);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 12);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 13);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 86);
                                                        //dd($field_status);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 87);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 88);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 89);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 90);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 91);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 92);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 93);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 14);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 15);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 94);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 16);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 17);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 18);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 30);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 31);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 32);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 35);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 39);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 40);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 41);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 42);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 36);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 37);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 38);
                                                    @endphp
                                                    @if(!$field_status['form_submit'])
                                                    <div class="row marg-left">
                                                        <div class="col-sm-4">
                                        ...
                                        <table class="table table-bordered">
                                            @foreach($employee_nominees as $key=>$employee_nominee)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 46, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 47, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 48, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 49, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 50, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 51, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                @if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 53, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
                                                            <div class="row marg-left">
                                                                <div class="col-sm-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 54, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
                                                            <div class="row marg-left">
                                                                <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 55, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 56, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 57, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 58, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 59, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 60, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 61, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 62, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] )
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 63, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 64, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 65, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 66, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] )
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 67, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 68, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 69, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] )
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 70, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] )
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 71, $employee_nominee->id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'] )
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                                        ...
                                        <table class="table table-bordered">
                                            @if(!empty($employee_documents))
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\NomineeUtil::checkApproveRejectStatusForPensionSection($application->id, 4, $employee_document->field_id);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
                            ...
                            @include('user.pension-section.approver.fp_form_part_3')

                            {{-- @include('user.pension-section.approver.calculation_sheet') --}}

                            @php
                                $oderDetails = DB::table('optcl_pension_application_form')->where('id', $application->id)->first();
                            @endphp
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('approver_family_pension_applications_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<div class="modal fade" id="application_approved_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('approver_family_pension_applications_approval') }}" method="post" id="application_approve_remark" accept-charset="utf-8">
        @csrf
        <input type="hidden" name="application_id" id="approve_application_id" value="{{ $application->id }}">
        <input type="hidden" name="application_status" id="approve_application_status">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Remark<span class="text-danger">*</span></label>
                                <textarea name="remarks" id="approve_remarks" placeholder="Enter Remark" class="form-control remark_textarea" rows="6" required maxlength="500"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#approve-btn').on('click', function() {
            ...
            $('#approve_application_status').val(1);
            $('#approve_application_id').val(application_id);

            $('#application_approved_remark').modal('show');
            $('#application_approved_remark').modal({
                backdrop: 'static',
                keyboard: false
            });
        });

        $("#application_approve_remark").validate({
            rules: {
                remarks: {
                    required: true,
                },
            ...
            submitHandler: function(form, event) { 
                    ...
                    $('#application_approved_remark').modal('hide');
                    form.submit();
            },
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('change', '.checkApprove', function() {
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("family_pension_hr_dealing_assistant_approval") }}',
                    type:'post',
