    			...
    			<div class="card">
    				<div class="card-body">
    					<h4 class="card-title">Application Details
                            @if(in_array($application->application_status_id, [36, 44]))
    					...
    					<div class="accordion" id="accordion" role="tablist">
    									...
    									<table class="table table-bordered">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 3);
                                                        @endphp
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 4);
                                                        @endphp
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 5);
                                                        @endphp
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 6);
                                                        @endphp
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 7);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 8);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 9);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 79);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 10);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
                                            ...
                                            <tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 11);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
                                                        <div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 12);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form1_id, 13);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    									...
    									<table class="table table-bordered">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 14);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 15);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 16);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 17);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 18);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
    											...
    											@if(!in_array($application->application_status_id, [1]))
                                                    <td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 19);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 20);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 21);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 22);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 23);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 24);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 25);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 26);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 27);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 28);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 29);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 30);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 31);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 32);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 34);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 35);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 36);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 37);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 38);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 39);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 40);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 41);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 42);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 43);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										<tr>
                                                ...
                                                @if(!in_array($application->application_status_id, [1]))
        											<td>
                                                        @php
                                                            $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form2_id, 44);
                                                        @endphp
                                                        @if(!$field_status['form_submit'])
        												<div class="row marg-left">
                                                            <div class="col-sm-4">
    										...
    										@foreach($employee_nominees as $key=>$employee_nominee)
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 46, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 47, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 48, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 49, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 50, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 51, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											@if(!empty($employee_nominee) && $employee_nominee->is_spouse == 1)
    												...
    												<tr>
                                                        ...
                                                        @if(!in_array($application->application_status_id, [1]))
        													<td>
                                                                @php
                                                                    $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 53, $employee_nominee->id);
                                                                @endphp
                                                                @if(!$field_status['form_submit'])
        														<div class="row marg-left">
                                                                    <div class="col-sm-4">
    												...
    												<tr>
                                                        ...
                                                        @if(!in_array($application->application_status_id, [1]))
        													<td>
                                                                @php
                                                                    $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 54, $employee_nominee->id);
                                                                @endphp
                                                                @if(!$field_status['form_submit'])
        														<div class="row marg-left">
                                                                    <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 55, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 56, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 57, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 58, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 59, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 60, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 61, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 62, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 63, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 64, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 65, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 66, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 67, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 68, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 69, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 70, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, $form3_id, 71, $employee_nominee->id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
    										...
    										@if(!empty($employee_documents))
    											...
    											<tr>
                                                    ...
                                                    @if(!in_array($application->application_status_id, [1]))
        												<td>
                                                            @php
                                                                $field_status = App\Libraries\Util::checkApproveRejectStatusForPensionSection($application->id, 4, $employee_document->field_id);
                                                            @endphp
                                                            @if(!$field_status['form_submit'])
        													<div class="row marg-left">
                                                                <div class="col-sm-4">
                            ...
                            @include('user.pension-section.initiator.form_part_3')

                            @include('user.pension-section.initiator.calculation_sheet')
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('initiator_applications_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<div class="modal fade" id="application_approved_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('initiator_applications_approval') }}" method="post" id="application_approve_remark" accept-charset="utf-8">
        @csrf
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.checkApproveNominee', function() {
            ...
            if(field_id != '') {
                $.ajax({
                    url:'{{ route("hr_executive_applications_approval") }}',
                    type:'post',
