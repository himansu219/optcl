                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="accordion" id="accordion" role="tablist">
                            ...
                            @include('user.pension-section.initiator.fp_form_part_3')
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('initiator_family_pension_applications_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<div class="modal fade" id="application_approved_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('initiator_family_pension_applications_approval') }}" method="post" id="application_approve_remark" accept-charset="utf-8">
        @csrf
