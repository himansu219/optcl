                ...
                <div class="card">
                    <div class="card-body">
                        <form id="sanction-order-submit" method="post" autocomplete="off" action="{{ route('approver_ppo_order_submit') }}" enctype="multipart/form-data">
                            ...
                            @if(!empty($document->identification_document_applicatnt))
                                <img src="{{url('public')}}/{{$document->identification_document_applicatnt}}" alt="image" class="brand_logo_2"/>
                            @else
                            ...
                            <div class="row">
                                ...
                                @else
                                    <div class="col-md-12">
                                        <label>Sanction of Family Pension & other pensionary benefits in favour of 
                                        Sri/Smt/Miss {{ $proposal->employee_name }} retired {{ (!empty($proposal->designation_name)) ? $proposal->designation_name : ''  }},
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                   <label>C) In the event of death of <b>Sri/Smt/Miss {{ $proposal->employee_name }}</b> before attaining the age of 65 years, Family Pension of Rs <b>{{ $service_form_three->service_pension }}/-</b> per month shall be payable to Sri/Smt./Miss Sopia Bhuyan spouse of pensioner from the day following the death of pensioner up to 17/04/2026 and thereafter @ Rs 15330/- till re-marriage OR death of family pensioner whichever is earlier.</label>
                                </div>
                            </div>
