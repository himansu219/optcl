                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Application Details
                            @if(in_array($application->application_status_id, [37, 45]))
                        ...
                        <div class="accordion" id="accordion" role="tablist">
                            ...
                            @include('user.pension-section.verifier.fp_form_part_3')

                            {{-- @include('user.pension-section.verifier.calculation_sheet') --}}
...
<div class="modal fade" id="application_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('verifier_family_pension_applications_approval') }}" method="post" id="application_return_remark" accept-charset="utf-8">
        @csrf
...
<div class="modal fade" id="application_approved_remark" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false">
    <form action="{{ route('verifier_family_pension_applications_approval') }}" method="post" id="application_approve_remark" accept-charset="utf-8">
        @csrf
