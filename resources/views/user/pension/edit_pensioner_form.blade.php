                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active-tab" id="home-tab" href="{{ route('edit_pensioner_form') }}">1. PENSION DETAILS</a>
                            </li>
                            <li class="nav-item">
                                              ...
                                              <div class="row form_1_">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="aadhaar_no" name="aadhaar_no" value="{{$pensionerDetails->aadhaar_no}}" placeholder="Enter Aadhaar No" value="" minlength="12" maxlength="12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control alpha" id="name" name="name" placeholder="Name" value="{{strtoupper($pensionerDetails->employee_name)}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="designation" name="designation">
                                                            ...
                                                            <option value="{{$list->id}}" @if($list->id == $pensionerDetails->designation_id) {{'selected'}} @endif>{{$list->designation_name}}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control alpha" id="father_name" name="father_name" placeholder="Father's Name" value="{{$pensionerDetails->father_name}}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" name="gender" id="gender">
                                                            ...
                                                            @foreach($genders as $gender)
                                                                <option value="{{$gender->id}}" @if($gender->id == $pensionerDetails->gender_id) {{'selected'}} @endif>{{$gender->gender_name}}</option>
                                                            @endforeach  
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" name="marital_status" id="marital_status">
                                                            ...
                                                            @foreach($mstatus as $mstatusValue)
                                                                <option value="{{$mstatusValue->id}}" @if($mstatusValue->id == $pensionerDetails->marital_status_id) {{'selected'}} @endif>{{$mstatusValue->marital_status_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <label id="marital_status-error" class="error text-danger" for="marital_status"></label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 husband_name @if($pensionerDetails->gender_id == 2 && $pensionerDetails->marital_status_id == 1) @else d-none @endif">
                                                    <div class="form-group">
                                                        <label for="exampleInputCity1">Husband's Name<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control alpha" id="husband_name" name="husband_name" placeholder="Husband's Name" value="{{$pensionerDetails->husband_name}}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="religion" name="religion">
                                                            ...
                                                            <option value="{{$list->id}}" @if($list->id == $pensionerDetails->religion_id) {{'selected'}} @endif>{{$list->religion_name}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="pf_acc_type" name="pf_acc_type">
                                                            <option value="">Select PF A/C Type</option>
                                                            @foreach($account_types as $account_type)
                                                                <option value="{{$account_type->id}}" @if($account_type->id == $pensionerDetails->pf_account_type_id) {{'selected'}} @endif>{{$account_type->account_type}}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="pf_acno" name="pf_acno" maxlength="5" placeholder="PF A/C No" value="{{$pensionerDetails->pf_account_no}}">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="name_of_office_dept" name="name_of_office_dept">
                                                            <option value="">Select Office</option>
                                                             @foreach($office_last_served as $list)
                                                                 <option value="{{$list->id}}" @if($list->id == $pensionerDetails->optcl_unit_id) {{'selected'}} @endif>{{$list->unit_name}}</option>
                                                             @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="inline-datepicker" class="input-group date">
                                                            <input type="text" class="form-control" id="dob" name="dob" readonly value="{{$pensionerDetails->date_of_birth ? date('d/m/Y',strtotime($pensionerDetails->date_of_birth)): ''}}">
    ...
    $(document).ready(function() {
       ...
       $("#name").on("keyup",function(){
        ...
        $("#save_as_draft").on('click',function(){
            ...
            var pf_acc_type = $("#pf_acc_type").select2('val');*/
            ...
            $.post('{{ route("save_as_draft_pensioner_form") }}',{
                "_token": "{{ csrf_token() }}",
                "emp_code":emp_code,
        ...
        $("#pension_form").validate({
            ...
            $('.page-loader').addClass('d-flex');
              ...
              $.ajax({
                  type:'POST',
                  url:'{{ route("update_pensioner_form") }}',
                  data: formData,
                  dataType: 'JSON',
                  processData: false,
                  contentType: false,
                  success: function(response) {
                    $('.page-loader').removeClass('d-flex');
                      if(response['error']){
                        ...
                        location.href = "{{route('edit_pensioner_form')}}";
                      }else{
                        // Success
                        //location.reload();
                        location.href = "{{route('personal_details')}}";
                      }
                  }
              });
            },
