                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control alpha_numeric" maxlength="100" id="atpost" name="atpost" placeholder="Enter At here" value="{{$personalDetails->permanent_addr_at}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword4">Post<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control alpha_numeric" maxlength="30" id="postoffice" name="postoffice" id="postoffice" placeholder="Enter Post here" value="{{$personalDetails->permanent_addr_post}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">PIN Code<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control only_number" id="pincode" name="pincode" placeholder="Enter Pin no here" maxlength="6" value="{{$personalDetails->permanent_addr_pincode}}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="country" name="country">
                                                        ...
                                                        <option value="{{$list->id}}" @if($list->id == $personalDetails->permanent_addr_country_id) {{'selected'}} @endif>{{$list->country_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="state" name="state">
                                                        ...
                                                        <option value="{{$countryStateValue->id}}" @if($countryStateValue->id == $personalDetails->permanent_addr_state_id) {{'selected'}} @endif>{{$countryStateValue->state_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="district" name="district">
                                                        ...
                                                        <option value="{{$countryStateDistrictValue->id}}" @if($countryStateDistrictValue->id == $personalDetails->permanent_addr_district_id) {{'selected'}} @endif>{{$countryStateDistrictValue->district_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputPassword4">At<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control alpha_numeric" maxlength="30" id="atpost1" name="atpost1" placeholder="Enter At here" value="{{$personalDetails->present_addr_at}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputPassword4">Post<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control alpha_numeric" maxlength="30" id="postoffice1" name="postoffice1" placeholder="Enter Post here" value="{{$personalDetails->present_addr_post}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">PIN Code<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control only_number" id="pincode1" name="pincode1" placeholder="Enter Pin no here" maxlength="6" value="{{$personalDetails->present_addr_pincode}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>Country<span class="text-danger">*</span> </label>
                                                    <select class="js-example-basic-single form-control" id="country1" name="country1">
                                                        <option value="">Select Country</option>
                                                        @foreach($country as $list)
                                                            <option value="{{$list->id}}" @if($list->id == $personalDetails->present_addr_country_id) {{'selected'}} @endif>{{$list->country_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="state1" name="state1">
                                                        <option value="">Select State</option>
                                                        @foreach($countryStates as $countryStateValue)
                                                        <option value="{{$countryStateValue->id}}" @if($countryStateValue->id == $personalDetails->present_addr_state_id) {{'selected'}} @endif>{{$countryStateValue->state_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="district1" name="district1">
                                                        <option value="">Select District</option>
                                                        @foreach($countryStateDistricts as $countryStateDistrictValue)
                                                        <option value="{{$countryStateDistrictValue->id}}" @if($countryStateDistrictValue->id == $personalDetails->present_addr_district_id) {{'selected'}} @endif>{{$countryStateDistrictValue->district_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="telephone_no" name="telephone_no" placeholder="Enter Telephone no here" minlength="11" maxlength="11" value="{{$personalDetails->telephone_std_code}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Mobile No<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control only_number" id="mobile_no" name="mobile_no" placeholder="Enter Mobile no here" minlength="10" maxlength="10" value="{{$personalDetails->mobile_no}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="exampleInputName1">Email Address (If Any)</label>
                                                    <input type="text" class="form-control" id="email" name="email" placeholder="Enter email here" value="{{$personalDetails->email_address}}" maxlength="96">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputName1">PAN No<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control anns" maxlength="10" id="pan_no" name="pan_no" placeholder="Enter pan no here" value="{{$personalDetails->pan_no}}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Savings Bank A/C No.(Single or Joint Account with Spouse)<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control only_number" id="saving_bank_ac_no" maxlength="18" name="saving_bank_ac_no" placeholder=" Saving A/C No" value="{{$personalDetails->savings_bank_account_no}}">
                                                </div>
                                                @php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="bank_name" name="bank_name">
                                                        ...
                                                        @foreach($banks as $bank)
                                                            <option value="{{$bank->id}}"  @if(($getBankData) && $bank->id == $getBankData->bank_id) {{'selected'}} @endif>{{$bank->bank_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="branch_name_address" name="branch_name_address">
                                                        ...
                                                        @foreach($branchs as $branch)
                                                            <option value="{{$branch->id}}"  @if($branch->id == $personalDetails->bank_branch_id) {{'selected'}} @endif>{{$branch->branch_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder=" Enter ifsc code" readonly value="{{ !empty($getBankData->ifsc_code) ? $getBankData->ifsc_code : '' }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">MICR Code<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="micr_code" name="micr_code" placeholder=" Enter micr code" readonly value="{{ !empty($getBankData->micr_code) ? $getBankData->micr_code : '' }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Amount of Basic pay at the time of Retirement<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="basic_pay" name="basic_pay" placeholder="Enter Last Basic Pay" value="{{ $personalDetails->basic_pay_amount_at_retirement }}">
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select class="js-example-basic-single form-control" id="name_of_the_unit" name="name_of_the_unit">
                                                        ...
                                                        @foreach($last_served as $unitData)
                                                            <option value="{{$unitData->id}}" @if($unitData->id == $personalDetails->pension_unit_id) {{'selected'}} @endif>{{$unitData->pension_unit_name}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="row" style="margin-left: 0px;">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="if_yes" id="if_yes" value="1"  @if($personalDetails->is_civil_service_amount_received == 1) {{'checked'}} @endif>
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="if_yes" id="if_nos" value="0"   @if($personalDetails->is_civil_service_amount_received == 0) {{'checked'}} @endif>
                                                                        No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control civil_service   @if($personalDetails->is_civil_service_amount_received == 1) d-inline @else d-none @endif" id="civil_service" name="civil_service" placeholder="Enter Particulars of previous civil service name"  value="{{ $personalDetails->civil_service_name }}" maxlength="50">    
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control gratuiyty_recieved   @if($personalDetails->is_civil_service_amount_received == 1) d-inline @else d-none @endif" id="gratuiyty_recieved" name="gratuiyty_recieved" placeholder="Enter amount and nature of any pension or gratuity received." value="{{ $personalDetails->civil_service_received_amount }}">    
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="row" style="margin-left: 0px;">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="addmissible" id="option_yes" value="1"   @if($personalDetails->is_family_pension_received_by_family_members == 1) {{'checked'}} @endif>
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="addmissible" id="option_no" value="0"    @if($personalDetails->is_family_pension_received_by_family_members == 0) {{'checked'}} @endif>
                                                                        No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control @if($personalDetails->is_family_pension_received_by_family_members == 1) d-inline @else d-none @endif alpha_numeric" id="addmissble_value" name="addmissble_value" placeholder="Enter admissible from any other source to the retired employee" value="{{ $personalDetails->admission_source_of_family_pension }}">
                                                    ...
                                                    <div class="row addmissible_family @if($personalDetails->is_family_pension_received_by_family_members == 1) d-flex @else d-none @endif">
                                                        <div class="col-sm-6">
                                                            <label class="admissible_label @if($personalDetails->is_family_pension_received_by_family_members == 1) {{'d-flex'}} @endif">Members of his family<span class="text-danger">*</span></label>
                                                            <select class="js-example-basic-single form-control" name="addmissible_family" id="addmissible_family">
                                                                <option value="">Select Relation</option>
                                                                @foreach($relations as $relation)
                                                                    <option value="{{$relation->id}}"  @if($relation->id == $personalDetails->family_member_relation_id) {{'selected'}} @endif>{{$relation->relation_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <input type="text" class="form-control" id="addmissible_family_name" name="addmissible_family_name" placeholder="Enter Name of member" value="{{ $personalDetails->family_member_name }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="row" style="margin-left: 0px;">
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="percentage" id="percentage_yes" value="1"    @if($personalDetails->is_commutation_pension_applied == 1) {{'checked'}} @endif>
                                                                        Yes
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <label class="form-check-label">
                                                                        <input type="radio" class="form-check-input" name="percentage" id="percentage_no" value="0"   @if($personalDetails->is_commutation_pension_applied == 0) {{'checked'}} @endif>
                                                                        No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <input type="text" class="form-control only_number @if($personalDetails->is_commutation_pension_applied == 1) d-inline @else d-none @endif" name="percentage_value" id="percentage_value" placeholder="Enter % only" value="{{ $personalDetails->commutation_percentage }}">
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {   
        ...
        $('.admissible_label').removeClass('d-inline');
        $('#addmissble_value').removeClass('d-inline');
        $('.addmissible_family').removeClass('d-inline');
        ...
        $("#form_2").validate({
            ...
            submitHandler: function(form, event) { 
              ...
              $.ajax({
                  type:'POST',
                  url:'{{ route("update_personal_details") }}',
                  data: formData,
                  dataType: 'JSON',
                  processData: false,
                  contentType: false,
