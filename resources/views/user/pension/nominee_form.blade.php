                        ...
                        <div class="tab-content">
                            <div class="">
                                <div class="media-body">
                                    ...
                                    <form action="{{ url('user/submit/nominee-details') }}" method="POST" class="forms-sample" enctype="multipart/form-data" id="nominee-details" autocomplete="off">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="{{ route('edit_personal_details') }}" class="btn btn-default mr-2 btn-prev">PREVIOUS</a>
    ...
    $(document).ready(function() {
        ...
        $(document).on('keyup', '.mobile_no', function() {
            ...
            if(sid.length > 0 && checkLenght == 0) {
                // $('#mobile_no_'+key+'-error').text('Initial 0 is not allowed for mobile no.').show();
                $(this).val('');
            }
        });
        ...
        $(document).on('focusout', '.mobile_no', function() {
            ...
            $.ajax({
                ...
                type:'post',
                data:'mobile_no='+sid+'&_token={{csrf_token()}}',
                success:function(result) {
                    $('.page-loader').removeClass('d-flex');
                    if(result === 'false') {
                        $('#mobile_no_'+key).val('');
        ...
        $(document).on('focusout', '.aadhaar_no', function() {
            ...
            $.ajax({
                ...
                type:'post',
                data:'aadhaar_no='+sid+'&_token={{csrf_token()}}',
                success:function(result) {
                    $('.page-loader').removeClass('d-flex');
                    if(result === 'false') {
                        $('#aadhaar_no_'+key).val('');
        ...
        $(document).on('change', '.relation_with_pensioner', function() {
            ...
            if(sid == 1) {
                $('#relation_with_pensioner_'+key+'-error').text('');
        ...
        $(document).on('change', '.employement_status', function() {
            ...
            if(sid == 2) {
                ...
                $('#employement_status_'+key+'-error').text('');
            } else {
                // $('#total_income_per_annum_' + key).val('');
        ...
        $(document).on('keyup', '.pension_amount_share_percentage', function() {
            ...
            if(checkLenght == 0) {
                // $('#pension_amount_share_percentage'+key+'-error').text('Initial 0 is not allowed for Amount / Share payable to Each').show();
                $(this).val('');
            }
        ...
        $(document).on('keyup', '.disability_percentage', function() {
            ...
            if(checkLenght == 0) {
                // $('#disability_percentage_'+key+'-error').text('Initial 0 is not allowed for disability percentage').show();
                $(this).val('');
            }
        ...
        $(document).on('keyup', '.legal_guardian_age', function() {
            ...
            if(checkLenght == 0) {
                // $('#legal_guardian_age'+key+'-error').text('Initial 0 is not allowed for legal guardian age.').show();
                $(this).val('');
            }
        });
        ...
        $(document).on('change', '.is_physically_handicapped', function() {
            ...
            if(sid != '') {
                $('#is_physically_handicapped_'+key+'-error').text('');
            }
        });
        ...
        $('#nominee-details').validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("save_nominee_details") }}',
                    data: formData,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
    ...
    function validate() {
        ...
        $('.savings_bank_account_no').each(function() {
            $(this).rules("add", {
                ...
                maxlength: 18,
                messages: {
                    required: "Please enter saving bank account no",
            ...
            $('.1st_spouse_death_certificate_path').each(function() {
                ...
                if(edit == 1) {
                    ...
                    $(this).rules("add", {
                        required: true,
                        messages: {
                            required: "Please upload spouse death certificate",
                        }
                    });
                }
            });
