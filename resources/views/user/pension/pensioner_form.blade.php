                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active-tab" id="home-tab" data-toggle="tab" href="#home-1" role="tab" aria-controls="home-1" aria-selected="true">1. PENSION DETAILS</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab">
                                <div class="media">
                                    <div class="media-body">
                                        <h4 class="mt-0 text-center">SERVIE PENSION FORM (Provisional / Final / Revised) PART - I</h4>
                                              ...
                                              <div class="row form_1_">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control only_number" id="aadhaar_no" name="aadhaar_no" value="{{ isset($employee_master->aadhaar_no) ? $employee_master->aadhaar_no: ''}}" placeholder="Enter Aadhaar No" value="" minlength="12" maxlength="12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div id="datepicker-joining" class="input-group date ">
                                                            <input type="text" class="form-control " readonly autocomplete="off" id="doj" name="doj" value="{{ isset($employee_master->date_of_joining) ? date('d/m/Y',strtotime($employee_master->date_of_joining)): ''}}">
                                                            <span class="input-group-addon input-group-append border-left">
                                                                <span class="mdi mdi-calendar input-group-text"></span>
                                                            </span>
                                                        </div>
