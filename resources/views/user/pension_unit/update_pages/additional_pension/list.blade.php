...
<div class="content-wrapper">
    ...
    <nav aria-label="breadcrumb" role="navigation" class="bg-white">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" >Additional Pension</li>
      </ol>
    </nav> 
          ...
          <div class="card-body">
              ...
              <form class="forms-sample" id="filter_applications" method="post" action="" autocomplete="off">
                  ...
                  <div class="row"> 
                    <div class="col-md-3">
                      <label>PPO No.</label>
                      <input type="text" name="ppo_no_search" class="form-control" id="ppo_no_search" value="{{ !empty($request->ppo_no_search) ? $request->ppo_no_search : '' }}" maxlength="20">
                    </div>
                    <div class="col-md-3">
                      <label>Pensioner Name</label>
                      <input type="text" name="pensioner_name" class="form-control" id="pensioner_name" value="{{ !empty($request->pensioner_name) ? $request->pensioner_name : '' }}" maxlength="20">
                    </div>             
                  </div><br>
                  <button type="submit" id="filters" class="btn btn-success">Filter</button>
                  <a href="{{ route('pension_unit_additional_pension_listing') }}" class="btn btn-warning">Reset</a>
              </form>
            </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
              <h4 class="card-title">Application List                
                  <a href="{{ route('pension_unit_update_additional_pension_add_page') }}" class="btn btn-success float-right">Add</a>                 
              </h4>
              <div class="row">
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" style="left: -21px;">
                                      <a href="{{ route('pension_unit_additional_pension_page_view', array($list->cID)) }}" class="dropdown-item delete_desig"><i class="fa fa-eye"></i>View Details</a>
                                    </div>
                                </div>
                            </div>
                          </td>
