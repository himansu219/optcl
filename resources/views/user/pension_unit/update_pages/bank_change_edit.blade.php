            ...
            <form method="post" action="" autocomplete="off" id="bank_change" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control ppo_number_format" maxlength="12" name="bc_ppo_number" id="bc_ppo_number" value="{{ $request_details->ppo_no }}">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control only_number" maxlength="6" name="bc_pension_emp_no" id="bc_pension_emp_no" value="{{ $request_details->pensioner_emp_no }}" >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control alpha" maxlength="100" name="bc_name_pensioner" id="bc_name_pensioner" value="{{ $request_details->pensioner_name }}">
                    ...
                    <div class="col-md-4 form-group">
                        <label>NOC Document<span class="text-danger">*</span><a href="{{ url('/') }}/public/{{ $request_details->noc_document }}" target="_blank"><i class="fa fa-paperclip"></i></a></label>
