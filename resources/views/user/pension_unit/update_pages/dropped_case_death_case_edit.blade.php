    ...
    <div class="col-12 grid-margin">
       <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Dropped Case/Death Case</li>
        </ol>
      </nav>
      ...
      <div class="card">
        ...
        <form method="post" action="" autocomplete="off" id="dropped_case_death_case">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control ppo_number_format" maxlength="12" name="dcdc_ppo_number" id="dcdc_ppo_number"  value="{{ $request_details->ppo_no }}">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control only_number" maxlength="6" name="dcdc_pension_emp_no" id="dcdc_pension_emp_no"  value="{{ $request_details->pensioner_emp_no }}">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control alpha" maxlength="100" name="dcdc_name_pensioner" id="dcdc_name_pensioner"  value="{{ $request_details->pensioner_name }}">
