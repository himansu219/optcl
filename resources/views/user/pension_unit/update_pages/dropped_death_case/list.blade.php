                  ...
                  @csrf
                    ...
                    <div class="row">
                      <div class="col-md-3 mt-2">
                        ...
                        <a href="{{ route('pension_unit_dropped_case_death_case_list') }}" class="btn btn-warning">Reset</a>
                      </div>
                    </div>
        ...
        <div class="card">
          <div class="card-body">
              <h4 class="card-title">Application List                
                  <a href="{{ route('pension_unit_dropped_case_death_case_add') }}" class="btn btn-success float-right">Add</a>                 
              </h4>
              <div class="row">
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" style="left: -21px;">
                                      <a href="{{ route('pension_unit_dropped_case_death_case_page', array($list->cID)) }}" class="dropdown-item edit_desig"><i class="fa fa-pencil-square-o"></i>Edit</a>
                                      <a href="{{ route('pension_unit_dropped_case_death_case_view', array($list->cID)) }}" class="dropdown-item delete_desig"><i class="fa fa-eye"></i>View Details</a>
                                    </div>
                                </div>
                            </div>
                          </td>
