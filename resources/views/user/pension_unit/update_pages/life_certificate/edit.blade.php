                            ...
                            <div class="col-md-8">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" class="form-control amount_type" maxlength="8" name="tds_info_total_income" id="tds_info_total_income" readonly value="{{ $request_details->total_income }}">                                            
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="amount_80c" id="amount_80c" class="form-control only_number" maxlength="6" value="{{ $request_details->amount_80c }}">                                            
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="amount_80d" id="amount_80d" class="form-control only_number" maxlength="5" value="{{ $request_details->amount_80d }}">                                             
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <select class="form-control" name="amount_8dd" id="amount_8dd">
                                                <option value="0" @if($request_details->amount_8dd == "0") selected @endif>Not Applicable</option>
                                                <option value="75000" @if($request_details->amount_8dd == "75000") selected @endif>75K</option>
                                                <option value="125000" @if($request_details->amount_8dd == "125000") selected @endif>125K</option>
                                            </select>                                          
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="amount_80e" id="amount_80e" class="form-control only_number" maxlength="7" value="{{ $request_details->amount_80e }}">                                      
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <select class="form-control" id="amount_80u" name="amount_80u">
                                                <option value="0" @if($request_details->amount_80u == "0") selected @endif>Not Applicable</option>
                                                <option value="75000" @if($request_details->amount_80u == "75000") selected @endif>75K</option>
                                                <option value="125000" @if($request_details->amount_80u == "125000") selected @endif>125K</option>
                                            </select>                                      
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <select class="form-control" id="amount_24b" name="amount_24b">
                                                <option value="0" @if($request_details->amount_24b == "0") selected @endif>Not Applicable</option>
                                                <option value="75000" @if($request_details->amount_24b == "75000") selected @endif>75K</option>
                                                <option value="125000" @if($request_details->amount_24b == "125000") selected @endif>125K</option>
                                            </select>                                  
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="others_amount" id="others_amount" class="form-control only_number" maxlength="7" value="{{ $request_details->others_amount }}">                                 
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="taxable_amount" id="taxable_amount" class="form-control only_number" readonly value="{{ number_format($request_details->taxable_amount, 2) }}">                                
