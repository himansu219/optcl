    ...
    <div class="col-12 grid-margin">
       <nav aria-label="breadcrumb" role="navigation">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('pension_unit_restoration_commutation') }}">Restoration of Commutation</a></li>
        ...
        <form method="post" action="" autocomplete="off" id="restoration_commutation">
            ...
            <div class="row">
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" class="form-control only_number" maxlength="6" name="rc_pension_emp_no" id="rc_pension_emp_no"  value="{{ $request_details->pensioner_emp_no }}" readonly>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" class="form-control alpha" maxlength="100" name="rc_name_pensioner" id="rc_name_pensioner"  value="{{ $request_details->pensioner_name }}" readonly>
                ...
                <div class="col-md-4 form-group">
                    ...
                    <select class="form-control" name="rc_rcv_comm_amt" id="rc_rcv_comm_amt">
                        ...
                        @foreach($commutations as $commutation_data)
                            <option value='{{ $commutation_data->commutation_amount }}' @if($commutation_data->commutation_amount == $request_details->rev_comm_amount) selected @endif>{{ $commutation_data->commutation_amount }}</option>               
                        @endforeach
                    </select>
