    ...
    <nav aria-label="breadcrumb" role="navigation" class="bg-white">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">Update Pension Record</li>
          <li class="breadcrumb-item" >Restoration of Commutation</li>
      </ol>
    </nav> 
                  ...
                  @csrf
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" name="rev_pensioner_name" class="form-control" id="rev_pensioner_name" value="{{ !empty($request->rev_pensioner_name) ? $request->rev_pensioner_name : '' }}" maxlength="50">
                      </div>
                      <div class="col-md-3">
                        <label>Date of Restoration</label>
                        <input type="text" name="date_restoration" class="form-control datepicker-default" id="date_restoration" value="{{ !empty($request->date_restoration) ? $request->date_restoration : '' }}" readonly>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-3 mt-2">
                        <button type="submit" id="filters" class="btn btn-success">Filter</button>
                        <a href="{{ route('pension_unit_restoration_commutation') }}" class="btn btn-warning">Reset</a>
                      </div>
                    </div>
        ...
        <div class="card">
          <div class="card-body">
              <h4 class="card-title">Application List                
                  <a href="{{ route('pension_unit_restoration_commutation_add') }}" class="btn btn-success float-right">Add</a>                 
              </h4>
              <div class="row">
                    ...
                    @if(count($result))
                      @foreach($result as $key => $list)
                        <tr>
                          ...
                          <td>{{ date("d/m/Y", strtotime($list->date_restoration)) }}</td>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" style="left: -21px;">
                                      <a href="{{ route('pension_unit_restoration_commutation_page', array($list->cID)) }}" class="dropdown-item edit_desig"><i class="fa fa-pencil-square-o"></i>Edit</a>
                                      <a href="{{ route('pension_unit_restoration_commutation_view', array($list->cID)) }}" class="dropdown-item delete_desig"><i class="fa fa-eye"></i>View Details</a>
                                    </div>
                                </div>
                            </div>
                          </td>
