...
<div class="content-wrapper">    
  <div class="row">
    <div class="col-12 grid-margin">
      ...
      <div class="card" id="revision_basic_pension_div">
          <div class="card-body">
              ...
              <form method="post" action="" autocomplete="off" id="revision_basic_pension">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4 form-group">
                          ...
                          <input type="text" class="form-control only_number" maxlength="6" name="rbp_pension_emp_no" id="rbp_pension_emp_no" readonly>
                      ...
                      <div class="col-md-4 form-group">
                          ...
                          <input type="text" class="form-control alpha" maxlength="100" name="rbp_name_pensioner" id="rbp_name_pensioner" readonly>
...
<script type="text/javascript">
    $(document).ready(function() {      
      ...
      $("#rbp_ppo_number").on('keyup', function (){
        var ppo_no = $(this).val();
        $.post("{{ route('revision_basic_pension_pensioner_details') }}",
        { 
          "_token": "{{ csrf_token() }}",
          "ppo_no": ppo_no,
        },function(response){
