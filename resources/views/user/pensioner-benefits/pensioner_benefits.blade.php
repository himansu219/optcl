                            ...
                            <li>
                                ...
                                <div class="row @if(!empty($commutation_value)) d-none @endif" id="commutation_rule_one_div">
                                    <div class="col-md-4">
                                        ...
                                        <select class="js-example-basic-single form-control mb-2" id="commutation_pension_id_data" name = "{{$proposal->id}}_{{$application->id}}"> 
                                            <option value="">Select Rule</option>
                        ...
                        <ol class="list-unstyled">
                            <li>
                                ...
                                <div class="row @if(!empty($commutation_two_value)) d-none @endif" id="commutation_rule_two_div">
                                    <div class="col-md-4">
                                        <label><strong>Rule</strong></label>
                                        <select class="js-example-basic-single form-control mb-2" id="commutation_pension_id_data_two" name = "{{$proposal->id}}_{{$application->id}}"> 
                                            <option value="">Select Rule</option>
                            ...
                            <li>
                                ...
                                <div class="row @if(!empty($commutation_three_value)) d-none @endif" id="commutation_rule_three_div">
                                    <div class="col-md-4">
                                        <label><strong>Rule</strong></label>
                                        <select class="js-example-basic-single form-control mb-2" id="commutation_pension_id_data_three" name = "{{$proposal->id}}_{{$application->id}}"> 
                                            <option value="">Select Rule</option>
                ...
                <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        <div class="row @if(!empty($family_pension_data)) d-none @endif" id="family_rule_div">
                            <div class="col-md-4">
                                <label>Rule</label>
                                <select class="js-example-basic-single form-control mb-2" id="family_pension_id_data" name = "{{$proposal->id}}_{{$application->id}}"> 
                                    <option value="">Select Rule</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#save-service-pension', function() {
            ...
            $.ajax({
                url:'{{ route("calculate_service_pension_save") }}',
                type:'post',
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#save-dcr-gratuity', function() {
            ...
            $.ajax({
                url:'{{ route("calculate_dcr_gratuity_save") }}',
                type:'post',
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#family_pension_id_data').on('change', function(){
            ...
            $.ajax({
                url:'{{ route("get_family_pension_details") }}',
                type:'post',
        ...
        $('#save_family_pension').on('click',function(){
            ...
            if(transaction_val != ""){
                $('.page-loader').addClass('d-flex');
                $.ajax({
                    url:'{{ route("save_transaction_details") }}',
                    type:'post',
        ...
        $('#commutation_pension_id_data').on('change', function(){
            ...
            $('.page-loader').addClass('d-flex');
            $.ajax({
                url:'{{ route("get_commutation_rule_one") }}',
                type:'post',
                data:'rule_id='+rule_id+'&_token={{csrf_token()}}&name_value='+name_value,
                success:function(result){  
                    console.log(result);
        ...
        $('#commutation_pension_id_data_two').on('change', function(){
            ...
            $('.page-loader').addClass('d-flex');
            $.ajax({
                url:'{{ route("get_commutation_rule_two") }}',
                type:'post',
                data:'rule_id='+rule_id+'&_token={{csrf_token()}}&name_value='+name_value,
                success:function(result){  
                    $('.page-loader').removeClass('d-flex');
        ...
        $('#commutation_pension_id_data_three').on('change', function(){
            ...
            $('.page-loader').addClass('d-flex');
            $.ajax({
                url:'{{ route("get_commutation_rule_three") }}',
                type:'post',
                data:'rule_id='+rule_id+'&_token={{csrf_token()}}&name_value='+name_value,
                success:function(result){  
                    $('.page-loader').removeClass('d-flex');
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#calculation-sheet-submit', function() {
            ...
            $.ajax({
                url:'{{ route("calculation_sheet_submitted") }}',
                type:'post',
