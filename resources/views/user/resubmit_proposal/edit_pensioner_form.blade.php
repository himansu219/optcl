                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active-tab" id="home-tab" href="{{ route('resubmit_page') }}">1. PENSION DETAILS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="" role="tab" aria-controls="profile-1" aria-selected="false">2. PERSONAL DETAILS</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h6 class="text-center-normal">(To be completed by the Employee/Applicant for sanction & payment of service pension, Death-cum-retirement Gratuity, Service Gratuity & Commuted value of pension)</h6>
                                        <hr>
                                            ...
                                            <input type="hidden" name="pension_form_id" value="{{$pensionerDetails->id}}">
                                              <div class="row form_1_">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                            $fieldStatus = App\Libraries\Util::check_field_return_status(3);
                                                        @endphp
                                                        <label for="exampleInputName1">Name (In Block Letter)<span class="text-danger">*</span></label>

                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(3);
                                                        @endphp
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(4);
                                                        @endphp
                                                        <label>Designation<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(4);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(5);
                                                        @endphp
                                                        <label for="exampleInputCity1">Father's Name<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(5);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(6);
                                                        @endphp
                                                        <label>Gender<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(6);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(7);
                                                        @endphp
                                                        <label>Marital Status<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(7);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6 husband_name">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(80);
                                                        @endphp
                                                        <label for="exampleInputCity1">Husband's Name<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(80);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(8);
                                                        @endphp
                                                        <label>Religion<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(8);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(9);
                                                        @endphp
                                                        <label for="exampleInputEmail3">PF A/C Type<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(9);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(79);
                                                        @endphp
                                                        ...
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(79);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(10);
                                                        @endphp
                                                        <label>Name of the Office / Dept. last Served <span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(10);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(11);
                                                        @endphp
                                                        <label class="">Date of Birth<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(11);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif

                                                        <div id="@if($fieldStatus){{'inline-datepicker'}}@endif" class="input-group date">
                                                            <input type="text" class="form-control" id="dob" name="dob" readonly value="{{$pensionerDetails->date_of_birth ? date('d/m/Y',strtotime($pensionerDetails->date_of_birth)): '' }}" @if(!$fieldStatus) readonly @endif>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(12);
                                                        @endphp
                                                        <label class="">Date of Joining in Service<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(12);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif

                                                        <div id="@if($fieldStatus){{'datepicker-joining'}}@endif" class="input-group date">
                                                            <input type="text" class="form-control" readonly autocomplete="off" id="doj" name="doj" value="{{$pensionerDetails->date_of_joining ? date('d/m/Y',strtotime($pensionerDetails->date_of_joining)): '' }}">
                                                            <span class="input-group-addon input-group-append">
                                                                <span class="mdi mdi-calendar input-group-text"></span>
                                                            </span>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        @php 
                                                          $fieldStatus = App\Libraries\Util::check_field_return_status(13);
                                                        @endphp
                                                        <label class="">Date of Retirement<span class="text-danger">*</span></label>
                                                        @php 
                                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(13);
                                                        @endphp
                                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                        @endif

                                                        <div id="@if($fieldStatus){{'datepicker-popup'}}@endif" class="input-group date">
                                                            <input type="text" class="form-control" readonly id="dor" name="dor" value="{{$pensionerDetails->date_of_retirement ? date('d/m/Y',strtotime($pensionerDetails->date_of_retirement)): '' }}">
                                                            <span class="input-group-addon input-group-append">
                                                                <span class="mdi mdi-calendar input-group-text"></span>
                                                            </span>
                                                        </div>
        ...
        $("#pension_form").validate({
            rules: {
                ...
                pf_acno: {
                    ...
                    maxlength: 5,
                    remote:{
                        url:'{{ route("validate_account_number") }}',
                        type:"post",
                        data:{
                            '_token': function() {
                               return '{{ csrf_token() }}';
            ...
            messages: {
                ...
                father_name: {
                    ...
                    minlength: 'Father\'s Name should be minimum of 4 Chars.',
                    maxlength: 'Father\'s Name should be maximum upto 50 Chars.'
                },
                gender : {                    
                ...
                pf_acc_type: {
                    required: 'Please select PF A/C type',
                },
                pf_acno: {
                    required: 'Please enter PF A/C no.',
                    minlength: 'PF A/C No  should be minimum  5 digits.',
                    maxlength: 'PF A/C No should be maximum 5 digits.',
                    remote: 'PF A/C No already exists',
                },
                name_of_office_dept: {
                  ...
                  success: function(response) {
                    $('.page-loader').removeClass('d-flex');
                      if(response['error']){
                        ...
                        // Success
                        //location.reload();
                        location.href = "{{route('personal_resubmit_page')}}";
                      }
                  }
              });
            },
