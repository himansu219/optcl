                ...
                <div class="card-body">
                    ...
                    <div class="employe-code-check">
                        <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('personal_resubmit_page') }}">2. PERSONAL DETAILS</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content">
                            <div class="">
                                <div class="media-body">
                                    ...
                                    <br />
                                    <form action="{{ route('save_nominee_details_resubmission') }}" method="POST" class="forms-sample" enctype="multipart/form-data" id="nominee-details" autocomplete="off">
                                        @csrf
                                        ...
                                        <div id="nominee_list">                                            
                                                                ...
                                                                <div class="row nominee_row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(46,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Full Name of the Family Member<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(46,$nominee_details->id);
                                                                            @endphp
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(47,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Mobile No.<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(47,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(48,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Date of Birth<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(48,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(49,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Proof of Date of Birth<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(49,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(50,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Gender<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(50,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(51,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Relation with Pensioner<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(51,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 spouse_type" id="spouse_type_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(52,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Spouse Type<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(52,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 is_second_spouse" id="is_second_spouse_death_date_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(53,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Death Date of 1st Spouse<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(53,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 is_second_spouse" id="is_second_spouse_death_cert_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(54,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Death Certificate of 1st Spouse<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(54,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(55,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Nominee Preference<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(55,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(56,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Name of the Bank<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(56,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(57,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Name Address of the Branch<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(57,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                            ...
                                                                            <select class="js-example-basic-single select-drop bank_branch branch" id="branch_{{$key}}" name="nominee[{{$key}}][branch]"  data-key="{{$key}}">
                                                                                ...
                                                                                @foreach($bank_branch as $branch)
                                                                                    <option @if(!empty($nominee_details) && $nominee_details->bank_branch_id == $branch->id) selected @endif @if(!empty($nominee_details) && !$fieldStatus && $nominee_details->bank_branch_id != $branch->id) disabled @endif  value="{{ $branch->id }}">{{ $branch->branch_name }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(58,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Savings Bank A/C No. (Single / Joint A/C with Spouse)<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(58,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(59,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Marital Status<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(59,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(60,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Aadhaar No.<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(60,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(61,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Employment Status<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(61,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(62,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Total Income per annum<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(62,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(63,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Physically Handicapped<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(63,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 physically_handicapped" id="physically_handicapped_cert_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(64,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Upload Disability Certificate<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(64,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 physically_handicapped" id="physically_handicapped_percentage_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(65,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Disability Percentage<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(65,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(66,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Amount / Share payable to Each<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(66,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(67,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Minor<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(67,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 is_legal" id="is_legal_name_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(68,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Legal Guardian Name<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(68,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 is_legal" id="is_legal_age_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(69,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Legal Guardian Age<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(69,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                            
                                                                            <input type="text" class="form-control legal_guardian_age" id="legal_guardian_age_{{$key}}" placeholder="Enter Legal Guardian Age" name="nominee[{{$key}}][legal_guardian_age]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->legal_guardian_age : '' }}">
                                                                    ...
                                                                    <div class="col-md-6 is_legal" id="is_legal_addr_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(70,$nominee_details->id);
                                                                            @endphp
                                                                            <label for="exampleInputEmail3">Address of Legal Guardian<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(70,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                                                    ...
                                                                    <div class="col-md-6 is_legal" id="is_legal_attch_{{$key}}">
                                                                        <div class="form-group">
                                                                            @php 
                                                                              $fieldStatus = App\Libraries\Util::check_field_return_status(71,$nominee_details->id);
                                                                            @endphp
                                                                            <label>Legal Guardian Attachment<span class="text-danger">*</span></label>
                                                                            @php 
                                                                                $return_remark_value = App\Libraries\Util::check_field_return_remark_show(71,$nominee_details->id);
                                                                            @endphp
                                                                            @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                                                            <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <button type="button" id="updateNominee" class="btn btn-primary mr-2 btn-next">NEXT</button>
                                                </div>
                                            </div>
                                        </div>                                        
                                    </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('keyup', '.mobile_no', function() {
            ...
            let checkLenght = sid.substring(0, 1);

            if(sid.length > 0 && checkLenght == 0) {
                $(this).val('');
            }
        });
        ...
        $(document).on('focusout', '.mobile_no', function() {
            ...
            $.ajax({
                url:'{{ route("validate_pensinor_nominee_mobile_number") }}',
                type:'post',
                data:'mobile_no='+sid+'&_token={{csrf_token()}}&nominee_id='+nominee_id,
                success:function(result) {
                    $('.page-loader').removeClass('d-flex');
                    if(result === 'false') {
                        $('#mobile_no_'+key).val('');
                        $('#mobile_no_' + key + '-error').text('Mobile No. already exists').show();
                    }
                }
            });
        });

        $(document).on('focusout', '.aadhaar_no', function() {
            let sid = $(this).val();
            let attr_id = $(this).attr('id');
            let key = $(this).data('key');
            let nominee_id = $('#nominee_id_' + key).val();
            ...
            $('.page-loader').addClass('d-flex');
            $.ajax({
                url:'{{ route("validate_pensinor_nominee_aadhar_number") }}',
                type:'post',
                data:'aadhaar_no='+sid+'&_token={{csrf_token()}}&nominee_id='+nominee_id,
                success:function(result) {
                    $('.page-loader').removeClass('d-flex');
                    if(result === 'false') {
                        $('#aadhaar_no_'+key).val('');
                        $('#aadhaar_no_' + key + '-error').text('Aadhaar No. already exists').show();
                    }
                }
            });
        });

        $(document).on('keyup', '.total_income_per_annum', function() {
            let sid = $(this).val();
            let attr_id = $(this).attr('id');
            let key = $(this).data('key');
            ...
            if(checkLenght == 0) {
                // $('#total_income_per_annum_'+key+'-error').text('Initial 0 is not allowed for total income per annum').show();
                $(this).val('');
            }

            if(sid > 100001) {
                $('#total_income_per_annum_' + key).val('');
                $('#total_income_per_annum_' + key + '-error').text('Total income per annum can not be more than 100000').removeClass('error-msg').css('display', 'block');
            }
        });
        ...
        $(document).on('change', '.marital_status ', function() {
            ...
            if(sid != '') {
                $('#marital_status_'+key+'-error').text('');
            }
        });
        ...
        $(document).on('keyup', '.legal_guardian_age', function() {
            let sid = $(this).val();
            let attr_id = $(this).attr('id');
            let key = $(this).data('key');
        ...
        /*$('#nominee-details').validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("save_nominee_details_resubmission") }}',
                    data: formData,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
                    success: function(response) {
                        ...
                        if(response['error']) {
                            ...
                            location.href = "{{ route('pension_documents_resubmit') }}";
        ...
        $('#updateNominee').on('click', function() {
            if($("#nominee-details").valid()) {
                $('.page-loader').addClass('d-flex');
                var form = $('#nominee-details')[0];
                var formData = new FormData(form);
            ...
            $('.savings_bank_account_no').each(function() {
                ...
                if(exist_data_key != key) {
                    if(exist_account_no == account_no) {
                        ...
                        $('#savings_bank_account_no_'+key).val('');
                        $('#savings_bank_account_no_' + key + '-error').text('Account No. already added').removeClass('error-msg').css('display', 'block');
                    }
                }
            });
                    ...
                    $.ajax({
                        ...
                        success:function(result) {
                            ...
                            if(result.status == 'error') {
                                ...
                                $('#savings_bank_account_no_'+key).val('');
                                $('#savings_bank_account_no_' + key + '-error').text(result.message).removeClass('error-msg').css('display', 'block');
                            }
                        }
                    });
                } else {
