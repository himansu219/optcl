            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab" href="{{ route('nominee_form_resubmit') }}">3. NOMINEES</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div>
                            ...
                            <form id="pension-documents" method="POST" class="forms-sample" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(72);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach recent passport size photograph with spouse (if married) and single photograph of self (applicant) duly attested<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(72);
                                        @endphp
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(74);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach attested copies of the date of birth certificates of all family members & nominee(s)<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(74);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(75);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach the Undertaking / Declaration for refund / recovery / of outstanding dues / excess payment wherever applicable<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(75);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(76);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach attested copy of the first page of Bank Pass Book with IFSC and MICR code<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(76);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(77);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach copy of cancelled cheque issued by the concerned bank<span class="text-danger">*</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                    @php 
                                        $return_remark_value = App\Libraries\Util::check_field_return_remark_show(77);
                                    @endphp
                                    @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                    <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                    @endif
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(78);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach Indemnity Bond (For the PF account which have not been transferred from the RPFC)<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(78);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(78);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach Indemnity Bond (For the PF account which have not been transferred from the RPFC)
                                        @php 
                                            $return_remark_value = App\Libraries\Util::check_field_return_remark_show(78);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                ...
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\Util::check_field_return_status(73);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attach three descriptive roll slips each bearing three specimen signatures (L.T.I if illiterate). Particulars of height and identification marks (at least 2 conspicuous marks) and left hand thumb and all fingers impression of the applicant duly attested by the head of office.<span class="text-danger">*</span>
                                    @php 
                                        $return_remark_value = App\Libraries\Util::check_field_return_remark_show(73);
                                    @endphp
                                    @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                    <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                    @endif
    ...
    $(document).ready(function() {
        $("#pension-documents").validate({
            ...
            submitHandler: function(form, event) {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("save_pension_documents_resubmission") }}',
                    data: formData,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
