                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control alpha_numeric" maxlength="30" id="atpost" name="atpost" placeholder="Enter At here" value="{{ isset($personal_details->permanent_addr_at) ? $personal_details->permanent_addr_at: ''}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="telephone_no" name="telephone_no" placeholder="Enter Telephone no here" minlength="10" maxlength="10" value="{{ isset($personal_details->telephone_std_code) ? $personal_details->telephone_std_code: ''}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Mobile No<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Enter Mobile no here" minlength="10" maxlength="10" value="{{ isset($personal_details->mobile_no) ? $personal_details->mobile_no: ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputName1">Email Address (If Any)</label>
                                                <input type="email" class="form-control" id="email" name="email" placeholder="Enter email here" value="{{ isset($personal_details->email_address) ? $personal_details->email_address: ''}}" >
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control only_number" id="basic_pay" name="basic_pay" placeholder="Enter Last Basic Pay" maxlength="8" value="{{ isset($personal_details->basic_pay_amount_at_retirement) ? $personal_details->basic_pay_amount_at_retirement: ''}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control civil_service" id="civil_service" name="civil_service" placeholder="Enter Particulars of previous civil service" maxlength="8"><br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="addmissble_value" name="addmissble_value" placeholder="Enter admissible form any other source to the retired employee">
