    ...
    <div class="row">
       <div class="col-12 grid-margin">
            ...
            @endif
             ...
             <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Current Pension Record</h4>
                      <div class="row">
                        <div class="table-sorter-wrapper col-lg-12 table-responsive">
                         <table id="sortable-table-1" class="table table-striped">
                            <thead>
                              <tr class="tablerow">
                                <th class="sortStyle">Bank Account No</th>
                            ...
                            <tbody>
                              ...
                              <tr class="tablerow" style="background-color: white">
                                <td>{{ $result->savings_bank_account_no }}</td>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample" id="update_pension_record_form" method="post" action="{{URL('update_pension_record_data')}}">
                        @csrf
                    ...
                    <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control numbersOnly" id="bank_account_no" name="bank_account_no" minlength="9" maxlength="18" placeholder="Enter Bank Account No" autocomplete="off">
                    ...
                    <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" placeholder="Enter IFSC Code" autocomplete="off" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="micr_code" name="micr_code" placeholder="Enter MICR Code" autocomplete="off" readonly>
