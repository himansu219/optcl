<div class="row nominee_row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control total_income_per_annum" id="total_income_per_annum_{{$key}}" placeholder="Enter Total Income per annum" name="nominee[{{$key}}][total_income_per_annum]"  data-key="{{$key}}"  value="{{ !empty($nominee_details) ? $nominee_details->total_income_per_annum : '' }}">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control pension_amount_share_percentage" id="pension_amount_share_percentage_{{$key}}" placeholder="Enter Amount / Share payable to Each" name="nominee[{{$key}}][pension_amount_share_percentage]"  data-key="{{$key}}" value="{{ !empty($nominee_details) ? $nominee_details->pension_amount_share_percentage : '' }}">
