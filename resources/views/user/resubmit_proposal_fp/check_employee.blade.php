                ...
                <div class="card-body">
                  ...
                  <div class="employe-code-check">
                    <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="home-tab" data-toggle="tab" href="#home-1" role="tab" aria-controls="home-1" aria-selected="true">1. PENSION/FAMILY PENSION FORM</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade show active" id="home-1" role="tabpanel" aria-labelledby="home-tab">
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <hr>
                                    <form method="POST" autocomplete="off" id="form_fetch_data" action="{{ route('pensioner_form') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="exampleInputPassword4" id="fetch_emp_info_label">Employee Code/Aadhaar No<span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control anns" id="fetch_emp_code" name="fetch_emp_code" value="{{$username}}" placeholder="Employee Code/Aadhaar No" readonly maxlength="12">
