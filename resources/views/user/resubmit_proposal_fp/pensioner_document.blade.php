            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-center mt-5" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="nominee-tab" href="{{ route('family_pensioner_nominee_form_resubmit') }}">3. NOMINEES</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active-tab" id="contact-tab" href="">4. LIST OF DOCUMENTS</a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div>
                            ...
                            <form id="pension-documents" method="POST" class="forms-sample" enctype="multipart/form-data">
                                ...
                                @php
                                    $attach_one = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 9)->where('deleted', 0)->first();
                                    //dd($attach_one);
                                @endphp
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(81);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of death certificate<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(81);
                                        @endphp
                                ...
                                @php
                                    $attach_three = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 10)->where('deleted', 0)->first();
                                @endphp
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(82);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Identification documents of the applicant viz.: Recent passport size photograph (attested on backside), 2 slips bearing specimen signatures / left thumb impressions and 2 slips bearing the present height and identification marks (at least 2 conspicuous marks) of the applicant.<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(82);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                @php
                                    $attach_four = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 11)->where('deleted', 0)->first();
                                @endphp
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(83);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Undertaking for recovery of excess payments, if any<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(83);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                @php
                                    $attach_five = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 12)->where('deleted', 0)->first();
                                @endphp
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(84);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of the Pension Payment Order<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(84);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                @php
                                    $attach_six = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 13)->where('deleted', 0)->first();
                                @endphp
                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(85);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Power of Attorney (Authorisation to retrieve the dues of the deceased pensioner by the family members) if applicable<span class="text-danger">*</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                    @php 
                                        $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(85);
                                    @endphp
                                    @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                    <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                    @endif
                                ...
                                @php
                                    $attach_seven = DB::table('optcl_nominee_pension_application_document')->where('nominee_master_id', $id)->where('document_id', 14)->where('deleted', 0)->first();
                                @endphp

                                <div class="form-group row">
                                    @php 
                                      $fieldStatus = App\Libraries\NomineeUtil::check_field_return_status(95);
                                    @endphp
                                    <label for="staticEmail" class="col-sm-6 col-form-label">Attested copy of legal heir certificate<span class="text-danger">*</span>
                                        @php 
                                            $return_remark_value = App\Libraries\NomineeUtil::check_field_return_remark_show(95);
                                        @endphp
                                        @if(!empty($return_remark_value) && $return_remark_value['return_status'] == true)
                                        <i class="fa fa-times-circle info-resubmission-remark" data-toggle="tooltip" data-placement="right" id="info-title-commutation-one" data-original-title="{{$return_remark_value['return_remark']}}"></i>
                                        @endif
                                ...
                                <a href="{{ route('nominee_form_resubmit') }}" class="btn btn-default mr-2 btn-prev">PREVIOUS</a>
                                <button type="submit" class="btn btn-primary mr-2">Save Details</button>
                            </form>
                        </div>
                    </div>
                    </div>
    ...
    $(document).ready(function() {
        $("#pension-documents").validate({
            ...
            submitHandler: function(form, event) {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{ route("family_pensioner_nominee_pension_documents_resubmission") }}',
                    data: formData,
                    dataType: 'JSON',
                    processData: false,
                    contentType: false,
