    ...
    <div class="col-12 grid-margin">
      ...
      <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" id="filter_applications" method="post" action="{{ route('dealing_applications') }}">
                @csrf
                <div class="row">
                  <div class="col-md-4">
                      ...
                      @foreach($applications as $key => $application)
                        <tr>
                          ...
                          <td>
                            ...
                            <a  href="{{ route('unit_head_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @else
                            <a  href="{{ route('family_pension_unit_head_application_details', array($application->id)) }}"><i class="fa fa-eye"></i></a>
                            @endif
